 ...
 * they read from FILLS/FONTS which get rebuilt when the active theme switches.
 *
 * Usage:
 *   import { setActiveTheme } from './styles';
 *   setActiveTheme('coastal');  // call before ExcelFormatter renders
 */
...
/**
 * Classic — the original Joe/Antares palette.
