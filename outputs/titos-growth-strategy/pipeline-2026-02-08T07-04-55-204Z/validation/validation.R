...
# Generated: 2026-02-08T07:26:30.151Z
...
if (!is.null(haven::val_labels(data[["A10_1"]])) && !identical(haven::val_labels(data[["A10_1"]]), haven::val_labels(data[["A10_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A10: labels differ between A10_1 and A10_2"))
}
if (!is.null(haven::val_labels(data[["A11_1"]])) && !identical(haven::val_labels(data[["A11_1"]]), haven::val_labels(data[["A11_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A11: labels differ between A11_1 and A11_2"))
}
if (!is.null(haven::val_labels(data[["A13_1"]])) && !identical(haven::val_labels(data[["A13_1"]]), haven::val_labels(data[["A13_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A13: labels differ between A13_1 and A13_2"))
}
if (!is.null(haven::val_labels(data[["A15_1"]])) && !identical(haven::val_labels(data[["A15_1"]]), haven::val_labels(data[["A15_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A15: labels differ between A15_1 and A15_2"))
}
if (!is.null(haven::val_labels(data[["A18_1"]])) && !identical(haven::val_labels(data[["A18_1"]]), haven::val_labels(data[["A18_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A18: labels differ between A18_1 and A18_2"))
}
if (!is.null(haven::val_labels(data[["A1_1"]])) && !identical(haven::val_labels(data[["A1_1"]]), haven::val_labels(data[["A1_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A1: labels differ between A1_1 and A1_2"))
}
if (!is.null(haven::val_labels(data[["A2_1"]])) && !identical(haven::val_labels(data[["A2_1"]]), haven::val_labels(data[["A2_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A2: labels differ between A2_1 and A2_2"))
}
if (!is.null(haven::val_labels(data[["A3_1"]])) && !identical(haven::val_labels(data[["A3_1"]]), haven::val_labels(data[["A3_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A3: labels differ between A3_1 and A3_2"))
}
if (!is.null(haven::val_labels(data[["A4_1"]])) && !identical(haven::val_labels(data[["A4_1"]]), haven::val_labels(data[["A4_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A4: labels differ between A4_1 and A4_2"))
}
if (!is.null(haven::val_labels(data[["A5_1"]])) && !identical(haven::val_labels(data[["A5_1"]]), haven::val_labels(data[["A5_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A5: labels differ between A5_1 and A5_2"))
}
if (!is.null(haven::val_labels(data[["A6_1"]])) && !identical(haven::val_labels(data[["A6_1"]]), haven::val_labels(data[["A6_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A6: labels differ between A6_1 and A6_2"))
}
if (!is.null(haven::val_labels(data[["A8_1"]])) && !identical(haven::val_labels(data[["A8_1"]]), haven::val_labels(data[["A8_2"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A8: labels differ between A8_1 and A8_2"))
}
if (!is.null(haven::val_labels(data[["A13_1r99oe"]])) && !identical(haven::val_labels(data[["A13_1r99oe"]]), haven::val_labels(data[["A13_2r99oe"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A13r99oe: labels differ between A13_1r99oe and A13_2r99oe"))
}
if (!is.null(haven::val_labels(data[["A16_1r10oe"]])) && !identical(haven::val_labels(data[["A16_1r10oe"]]), haven::val_labels(data[["A16_2r10oe"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A16r10oe: labels differ between A16_1r10oe and A16_2r10oe"))
}
if (!is.null(haven::val_labels(data[["A17_1r9oe"]])) && !identical(haven::val_labels(data[["A17_1r9oe"]]), haven::val_labels(data[["A17_2r9oe"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A17r9oe: labels differ between A17_1r9oe and A17_2r9oe"))
}
if (!is.null(haven::val_labels(data[["A18_1r8oe"]])) && !identical(haven::val_labels(data[["A18_1r8oe"]]), haven::val_labels(data[["A18_2r8oe"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A18r8oe: labels differ between A18_1r8oe and A18_2r8oe"))
}
if (!is.null(haven::val_labels(data[["A19_1r11oe"]])) && !identical(haven::val_labels(data[["A19_1r11oe"]]), haven::val_labels(data[["A19_2r11oe"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A19r11oe: labels differ between A19_1r11oe and A19_2r11oe"))
}
if (!is.null(haven::val_labels(data[["A4_1r15oe"]])) && !identical(haven::val_labels(data[["A4_1r15oe"]]), haven::val_labels(data[["A4_2r15oe"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("A4r15oe: labels differ between A4_1r15oe and A4_2r15oe"))
}
if (!is.null(haven::val_labels(data[["hCHANNEL_1r1"]])) && !identical(haven::val_labels(data[["hCHANNEL_1r1"]]), haven::val_labels(data[["hCHANNEL_2r1"]]))) {
  label_conflict_warnings <- c(label_conflict_warnings, paste0("hCHANNELr1: labels differ between hCHANNEL_1r1 and hCHANNEL_2r1"))
}
if (!is.null(haven::val_labels(data[["hCHANNEL_1r2"]])) && !identical(haven::val_labels(data[["hCHANNEL_1r2"]]), haven::val_labels(data[["hCHANNEL_2r2"]]))) {
...
validation_results[["s1"]] <- tryCatch({
  ...
  # Row 1: NET - Any listed industry (NET)
...
# -----------------------------------------------------------------------------
# Table: s2_hAge_bands (frequency)
# -----------------------------------------------------------------------------

validation_results[["s2_hAge_bands"]] <- tryCatch({

  # Row 1: S2 == 21-34
  if (!("S2" %in% names(data))) stop("Variable 'S2' not found")
  test_val <- sum(as.numeric(data[["S2"]]) >= 21 & as.numeric(data[["S2"]]) <= 34, na.rm = TRUE)
  # Row 2: S2 == 21-24
  if (!("S2" %in% names(data))) stop("Variable 'S2' not found")
  test_val <- sum(as.numeric(data[["S2"]]) >= 21 & as.numeric(data[["S2"]]) <= 24, na.rm = TRUE)
  # Row 3: S2 == 25-34
  if (!("S2" %in% names(data))) stop("Variable 'S2' not found")
  test_val <- sum(as.numeric(data[["S2"]]) >= 25 & as.numeric(data[["S2"]]) <= 34, na.rm = TRUE)
  # Row 4: S2 == 35-54
  if (!("S2" %in% names(data))) stop("Variable 'S2' not found")
  test_val <- sum(as.numeric(data[["S2"]]) >= 35 & as.numeric(data[["S2"]]) <= 54, na.rm = TRUE)
  # Row 5: S2 == 35-44
  if (!("S2" %in% names(data))) stop("Variable 'S2' not found")
  test_val <- sum(as.numeric(data[["S2"]]) >= 35 & as.numeric(data[["S2"]]) <= 44, na.rm = TRUE)
  # Row 6: S2 == 45-54
  if (!("S2" %in% names(data))) stop("Variable 'S2' not found")
  test_val <- sum(as.numeric(data[["S2"]]) >= 45 & as.numeric(data[["S2"]]) <= 54, na.rm = TRUE)
  # Row 7: S2 == 55-74
  if (!("S2" %in% names(data))) stop("Variable 'S2' not found")
  test_val <- sum(as.numeric(data[["S2"]]) >= 55 & as.numeric(data[["S2"]]) <= 74, na.rm = TRUE)
  # Row 8: S2 == 55-64
  if (!("S2" %in% names(data))) stop("Variable 'S2' not found")
  test_val <- sum(as.numeric(data[["S2"]]) >= 55 & as.numeric(data[["S2"]]) <= 64, na.rm = TRUE)
  # Row 9: S2 == 65-74
  if (!("S2" %in% names(data))) stop("Variable 'S2' not found")
  test_val <- sum(as.numeric(data[["S2"]]) >= 65 & as.numeric(data[["S2"]]) <= 74, na.rm = TRUE)

  list(success = TRUE, tableId = "s2_hAge_bands", rowCount = 9)

}, error = function(e) {
  list(success = FALSE, tableId = "s2_hAge_bands", error = conditionMessage(e))
})

print(paste("Validated:", "s2_hAge_bands", "-", if(validation_results[["s2_hAge_bands"]]$success) "PASS" else paste("FAIL:", validation_results[["s2_hAge_bands"]]$error)))
...
validation_results[["s5"]] <- tryCatch({
  ...
  test_val <- sum(as.numeric(data[["S5"]]) %in% c(1, 2), na.rm = TRUE)
  # Row 2: S5 == 1
  if (!("S5" %in% names(data))) stop("Variable 'S5' not found")
  ...
  # Row 4: S5 == 3,4,5
  if (!("S5" %in% names(data))) stop("Variable 'S5' not found")
  test_val <- sum(as.numeric(data[["S5"]]) %in% c(3, 4, 5), na.rm = TRUE)
  # Row 5: S5 == 3
  if (!("S5" %in% names(data))) stop("Variable 'S5' not found")
  ...
  # Row 8: S5 == 6,7,8,9
  if (!("S5" %in% names(data))) stop("Variable 'S5' not found")
  test_val <- sum(as.numeric(data[["S5"]]) %in% c(6, 7, 8, 9), na.rm = TRUE)
  # Row 9: S5 == 6
  if (!("S5" %in% names(data))) stop("Variable 'S5' not found")
  ...
  list(success = TRUE, tableId = "s5", rowCount = 13)
...
validation_results[["s6a"]] <- tryCatch({
  ...
  # Row 1: NET - Any family origin (NET)
...
validation_results[["s7"]] <- tryCatch({
  ...
  # Row 1: NET - Any race selected (NET)
...
validation_results[["s8_binned"]] <- tryCatch({
  ...
  # Row 1: S8 == 1
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) == 1, na.rm = TRUE)
  # Row 2: S8 == 2-3
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) >= 2 & as.numeric(data[["S8"]]) <= 3, na.rm = TRUE)
  # Row 3: S8 == 4-6
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) >= 4 & as.numeric(data[["S8"]]) <= 6, na.rm = TRUE)
  # Row 4: S8 == 7-9
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) >= 7 & as.numeric(data[["S8"]]) <= 9, na.rm = TRUE)
  # Row 5: S8 == 10-50
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) >= 10 & as.numeric(data[["S8"]]) <= 50, na.rm = TRUE)

  list(success = TRUE, tableId = "s8_binned", rowCount = 5)
...
# -----------------------------------------------------------------------------
# Table: s10a_reference_nochange (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10a_reference_nochange"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s10a_reference_nochange", rowCount = 8)

}, error = function(e) {
  list(success = FALSE, tableId = "s10a_reference_nochange", error = conditionMessage(e))
})

print(paste("Validated:", "s10a_reference_nochange", "-", if(validation_results[["s10a_reference_nochange"]]$success) "PASS" else paste("FAIL:", validation_results[["s10a_reference_nochange"]]$error)))
...
# -----------------------------------------------------------------------------
# Table: s10b_detail (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_detail"]] <- tryCatch({

  # Row 1: Category header - Connection / Belonging (skip validation)
  # Row 2: S10b == 1,2,3,4,100
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(1, 2, 3, 4, 100), na.rm = TRUE)
  # Row 3: S10b == 1
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 1, na.rm = TRUE)
  # Row 4: S10b == 2
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 100, na.rm = TRUE)
  # Row 8: Category header - Status / Image (skip validation)
  # Row 9: S10b == 6,7,8,9,101
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(6, 7, 8, 9, 101), na.rm = TRUE)
  # Row 10: S10b == 6
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 6, na.rm = TRUE)
  # Row 11: S10b == 7
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 101, na.rm = TRUE)
  # Row 15: Category header - Exploration / Discovery (skip validation)
  # Row 16: S10b == 11,12,13,14,102
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(11, 12, 13, 14, 102), na.rm = TRUE)
  # Row 17: S10b == 11
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 11, na.rm = TRUE)
  # Row 18: S10b == 12
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 102, na.rm = TRUE)
  # Row 22: Category header - Celebration (skip validation)
  # Row 23: S10b == 16,17,19,103
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(16, 17, 19, 103), na.rm = TRUE)
  # Row 24: S10b == 16
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 16, na.rm = TRUE)
  # Row 25: S10b == 17
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 103, na.rm = TRUE)
  # Row 28: Category header - Indulgence (skip validation)
  # Row 29: S10b == 21,24,40,104
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(21, 24, 40, 104), na.rm = TRUE)
  # Row 30: S10b == 21
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 21, na.rm = TRUE)
  # Row 31: S10b == 24
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 104, na.rm = TRUE)
  # Row 34: Category header - Escape / Relief (skip validation)
  # Row 35: S10b == 26,27,28,29,105
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(26, 27, 28, 29, 105), na.rm = TRUE)
  # Row 36: S10b == 26
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 26, na.rm = TRUE)
  # Row 37: S10b == 27
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 105, na.rm = TRUE)
  # Row 41: Category header - Performance (skip validation)
  # Row 42: S10b == 31,32,34,106
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(31, 32, 34, 106), na.rm = TRUE)
  # Row 43: S10b == 31
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 31, na.rm = TRUE)
  # Row 44: S10b == 32
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 106, na.rm = TRUE)
  # Row 47: Category header - Tradition (skip validation)
  # Row 48: S10b == 36,37,38,39,107
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(36, 37, 38, 39, 107), na.rm = TRUE)
  # Row 49: S10b == 36
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 36, na.rm = TRUE)
  # Row 50: S10b == 37
  ...
  list(success = TRUE, tableId = "s10b_detail", rowCount = 53)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_detail", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_detail", "-", if(validation_results[["s10b_detail"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_detail"]]$error)))

# -----------------------------------------------------------------------------
# Table: s10b_overview (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_overview"]] <- tryCatch({

  # Row 1: S10b == 1,2,3,4,100
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(1, 2, 3, 4, 100), na.rm = TRUE)
  # Row 2: S10b == 6,7,8,9,101
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(6, 7, 8, 9, 101), na.rm = TRUE)
  # Row 3: S10b == 11,12,13,14,102
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(11, 12, 13, 14, 102), na.rm = TRUE)
  # Row 4: S10b == 16,17,19,103
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(16, 17, 19, 103), na.rm = TRUE)
  # Row 5: S10b == 21,24,40,104
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(21, 24, 40, 104), na.rm = TRUE)
  # Row 6: S10b == 26,27,28,29,105
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(26, 27, 28, 29, 105), na.rm = TRUE)
  # Row 7: S10b == 31,32,34,106
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(31, 32, 34, 106), na.rm = TRUE)
  # Row 8: S10b == 36,37,38,39,107
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) %in% c(36, 37, 38, 39, 107), na.rm = TRUE)

  list(success = TRUE, tableId = "s10b_overview", rowCount = 8)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_overview", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_overview", "-", if(validation_results[["s10b_overview"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_overview"]]$error)))
...
validation_results[["s11b"]] <- tryCatch({
  ...
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(1, 2, 3, 4), na.rm = TRUE)
  # Row 2: S11b == 1
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 6: S11b == 6,7,8,9
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(6, 7, 8, 9), na.rm = TRUE)
  # Row 7: S11b == 6
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 11: S11b == 11,12,13,14
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(11, 12, 13, 14), na.rm = TRUE)
  # Row 12: S11b == 11
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 16: S11b == 16,17,19
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(16, 17, 19), na.rm = TRUE)
  # Row 17: S11b == 16
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 20: S11b == 21,24,40
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(21, 24, 40), na.rm = TRUE)
  # Row 21: S11b == 21
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 24: S11b == 26,27,28,29
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(26, 27, 28, 29), na.rm = TRUE)
  # Row 25: S11b == 26
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 29: S11b == 31,32,34
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(31, 32, 34), na.rm = TRUE)
  # Row 30: S11b == 31
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 33: S11b == 36,37,38,39
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(36, 37, 38, 39), na.rm = TRUE)
  # Row 34: S11b == 36
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 38: S11b == 100,101,102,103,104,105,106,107
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(100, 101, 102, 103, 104, 105, 106, 107), na.rm = TRUE)
  # Row 39: S11b == 100
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  list(success = TRUE, tableId = "s11b", rowCount = 46)
...
# -----------------------------------------------------------------------------
# Table: s11b_jtbd_summary (frequency)
# -----------------------------------------------------------------------------

validation_results[["s11b_jtbd_summary"]] <- tryCatch({
  ...
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(21, 24, 40), na.rm = TRUE)
  # Row 6: S11b == 26,27,28,29
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(26, 27, 28, 29), na.rm = TRUE)
  # Row 7: S11b == 31,32,34
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(31, 32, 34), na.rm = TRUE)
  # Row 8: S11b == 36,37,38,39
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(36, 37, 38, 39), na.rm = TRUE)
  # Row 9: S11b == 100,101,102,103,104,105,106,107
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) %in% c(100, 101, 102, 103, 104, 105, 106, 107), na.rm = TRUE)

  list(success = TRUE, tableId = "s11b_jtbd_summary", rowCount = 9)

}, error = function(e) {
  list(success = FALSE, tableId = "s11b_jtbd_summary", error = conditionMessage(e))
})

print(paste("Validated:", "s11b_jtbd_summary", "-", if(validation_results[["s11b_jtbd_summary"]]$success) "PASS" else paste("FAIL:", validation_results[["s11b_jtbd_summary"]]$error)))
...
validation_results[["s11c"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s11c", rowCount = 5)
...
validation_results[["a2"]] <- tryCatch({
  ...
  test_val <- sum(as.numeric(stacked_loop_1[["A2"]]) %in% c(1, 2, 3), na.rm = TRUE)
  # Row 2: A2 == 1
  if (!("A2" %in% names(stacked_loop_1))) stop("Variable 'A2' not found")
  ...
  # Row 5: A2 == 4,5,6
  if (!("A2" %in% names(stacked_loop_1))) stop("Variable 'A2' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A2"]]) %in% c(4, 5, 6), na.rm = TRUE)
  # Row 6: A2 == 4
  if (!("A2" %in% names(stacked_loop_1))) stop("Variable 'A2' not found")
  ...
  list(success = TRUE, tableId = "a2", rowCount = 9)
...
validation_results[["a4"]] <- tryCatch({
  ...
  test_val <- sum(as.numeric(stacked_loop_1[["A4"]]) %in% c(1, 2, 5, 6), na.rm = TRUE)
  # Row 2: A4 == 1
  if (!("A4" %in% names(stacked_loop_1))) stop("Variable 'A4' not found")
  ...
  # Row 6: A4 == 3,4
  if (!("A4" %in% names(stacked_loop_1))) stop("Variable 'A4' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A4"]]) %in% c(3, 4), na.rm = TRUE)
  # Row 7: A4 == 3
  if (!("A4" %in% names(stacked_loop_1))) stop("Variable 'A4' not found")
  ...
  # Row 9: A4 == 7,8,9,10,11,12,13,14,15
  if (!("A4" %in% names(stacked_loop_1))) stop("Variable 'A4' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A4"]]) %in% c(7, 8, 9, 10, 11, 12, 13, 14, 15), na.rm = TRUE)
  # Row 10: A4 == 7
  if (!("A4" %in% names(stacked_loop_1))) stop("Variable 'A4' not found")
  ...
  list(success = TRUE, tableId = "a4", rowCount = 18)
...
# -----------------------------------------------------------------------------
# Table: a10_dist (frequency) [loop: stacked_loop_1]
# -----------------------------------------------------------------------------

validation_results[["a10_dist"]] <- tryCatch({
  ...
  # Row 4: A10 == 8-15
  if (!("A10" %in% names(stacked_loop_1))) stop("Variable 'A10' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A10"]]) >= 8 & as.numeric(stacked_loop_1[["A10"]]) <= 15, na.rm = TRUE)
  # Row 5: A10 == 16-30
  if (!("A10" %in% names(stacked_loop_1))) stop("Variable 'A10' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A10"]]) >= 16 & as.numeric(stacked_loop_1[["A10"]]) <= 30, na.rm = TRUE)

  list(success = TRUE, tableId = "a10_dist", rowCount = 5)

}, error = function(e) {
  list(success = FALSE, tableId = "a10_dist", error = conditionMessage(e))
})

print(paste("Validated:", "a10_dist", "-", if(validation_results[["a10_dist"]]$success) "PASS" else paste("FAIL:", validation_results[["a10_dist"]]$error)))
...
validation_results[["a13"]] <- tryCatch({
  ...
  # Row 1: Category header - VODKA (skip validation)
  # Row 2: A13 == 1
  ...
  # Row 12: Category header - WHISKEY / BOURBON (skip validation)
  # Row 13: A13 == 11
  if (!("A13" %in% names(stacked_loop_1))) stop("Variable 'A13' not found")
  ...
  # Row 23: Category header - TEQUILA / MEZCAL (skip validation)
  # Row 24: A13 == 21
  if (!("A13" %in% names(stacked_loop_1))) stop("Variable 'A13' not found")
  ...
  # Row 34: Category header - RUM (skip validation)
  # Row 35: A13 == 31
  if (!("A13" %in% names(stacked_loop_1))) stop("Variable 'A13' not found")
  ...
  # Row 45: Category header - GIN (skip validation)
  # Row 46: A13 == 41
  if (!("A13" %in% names(stacked_loop_1))) stop("Variable 'A13' not found")
  ...
  # Row 56: Category header - LIQUEURS / OTHER SPIRITS (skip validation)
  # Row 57: A13 == 51
  if (!("A13" %in% names(stacked_loop_1))) stop("Variable 'A13' not found")
  ...
  # Row 67: Category header - COGNAC (skip validation)
  # Row 68: A13 == 61
  if (!("A13" %in% names(stacked_loop_1))) stop("Variable 'A13' not found")
  ...
  # Row 78: Category header - OTHER / STORE / UNKNOWN (skip validation)
  # Row 79: A13 == 98
  if (!("A13" %in% names(stacked_loop_1))) stop("Variable 'A13' not found")
  ...
  list(success = TRUE, tableId = "a13", rowCount = 81)
...
validation_results[["a20"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a20", rowCount = 7)
...
validation_results[["a21"]] <- tryCatch({
  ...
  # Row 1: NET - Any brand awareness (NET)
...
# -----------------------------------------------------------------------------
# Table: a22_brand_col_c1_a21r1_ (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_brand_col_c1_a21r1_"]] <- tryCatch({

  # Row 1: NET - Any attribute associated with Tito's (NET)
  if (!("A22r1c1" %in% names(data))) stop("NET component variable 'A22r1c1' not found")
  if (!("A22r2c1" %in% names(data))) stop("NET component variable 'A22r2c1' not found")
  if (!("A22r3c1" %in% names(data))) stop("NET component variable 'A22r3c1' not found")
  if (!("A22r4c1" %in% names(data))) stop("NET component variable 'A22r4c1' not found")
  if (!("A22r5c1" %in% names(data))) stop("NET component variable 'A22r5c1' not found")
  if (!("A22r6c1" %in% names(data))) stop("NET component variable 'A22r6c1' not found")
  if (!("A22r7c1" %in% names(data))) stop("NET component variable 'A22r7c1' not found")
  if (!("A22r8c1" %in% names(data))) stop("NET component variable 'A22r8c1' not found")
  if (!("A22r9c1" %in% names(data))) stop("NET component variable 'A22r9c1' not found")
  if (!("A22r10c1" %in% names(data))) stop("NET component variable 'A22r10c1' not found")
  # Row 2: A22r1c1 == 1
  ...
  list(success = TRUE, tableId = "a22_brand_col_c1_a21r1_", rowCount = 11)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_brand_col_c1_a21r1_", error = conditionMessage(e))
})

print(paste("Validated:", "a22_brand_col_c1_a21r1_", "-", if(validation_results[["a22_brand_col_c1_a21r1_"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_brand_col_c1_a21r1_"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_brand_col_c2_a21r2_ (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_brand_col_c2_a21r2_"]] <- tryCatch({

  # Row 1: Category header - Attributes associated with Grey Goose: (skip validation)
  # Row 2: A22r1c2 == 1
  ...
  list(success = TRUE, tableId = "a22_brand_col_c2_a21r2_", rowCount = 11)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_brand_col_c2_a21r2_", error = conditionMessage(e))
})

print(paste("Validated:", "a22_brand_col_c2_a21r2_", "-", if(validation_results[["a22_brand_col_c2_a21r2_"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_brand_col_c2_a21r2_"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_brand_col_c3_a21r3_ (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_brand_col_c3_a21r3_"]] <- tryCatch({

  # Row 1: NET - Associated with any attribute (NET)
  if (!("A22r1c3" %in% names(data))) stop("NET component variable 'A22r1c3' not found")
  if (!("A22r2c3" %in% names(data))) stop("NET component variable 'A22r2c3' not found")
  if (!("A22r3c3" %in% names(data))) stop("NET component variable 'A22r3c3' not found")
  if (!("A22r4c3" %in% names(data))) stop("NET component variable 'A22r4c3' not found")
  if (!("A22r5c3" %in% names(data))) stop("NET component variable 'A22r5c3' not found")
  if (!("A22r6c3" %in% names(data))) stop("NET component variable 'A22r6c3' not found")
  if (!("A22r7c3" %in% names(data))) stop("NET component variable 'A22r7c3' not found")
  if (!("A22r8c3" %in% names(data))) stop("NET component variable 'A22r8c3' not found")
  if (!("A22r9c3" %in% names(data))) stop("NET component variable 'A22r9c3' not found")
  if (!("A22r10c3" %in% names(data))) stop("NET component variable 'A22r10c3' not found")
  # Row 2: A22r1c3 == 1
  ...
  list(success = TRUE, tableId = "a22_brand_col_c3_a21r3_", rowCount = 11)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_brand_col_c3_a21r3_", error = conditionMessage(e))
})

print(paste("Validated:", "a22_brand_col_c3_a21r3_", "-", if(validation_results[["a22_brand_col_c3_a21r3_"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_brand_col_c3_a21r3_"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_brand_col_c4_a21r4_ (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_brand_col_c4_a21r4_"]] <- tryCatch({

  # Row 1: NET - Associated with any attribute (NET)
  if (!("A22r1c4" %in% names(data))) stop("NET component variable 'A22r1c4' not found")
  if (!("A22r2c4" %in% names(data))) stop("NET component variable 'A22r2c4' not found")
  if (!("A22r3c4" %in% names(data))) stop("NET component variable 'A22r3c4' not found")
  if (!("A22r4c4" %in% names(data))) stop("NET component variable 'A22r4c4' not found")
  if (!("A22r5c4" %in% names(data))) stop("NET component variable 'A22r5c4' not found")
  if (!("A22r6c4" %in% names(data))) stop("NET component variable 'A22r6c4' not found")
  if (!("A22r7c4" %in% names(data))) stop("NET component variable 'A22r7c4' not found")
  if (!("A22r8c4" %in% names(data))) stop("NET component variable 'A22r8c4' not found")
  if (!("A22r9c4" %in% names(data))) stop("NET component variable 'A22r9c4' not found")
  if (!("A22r10c4" %in% names(data))) stop("NET component variable 'A22r10c4' not found")
  # Row 2: A22r1c4 == 1
  ...
  list(success = TRUE, tableId = "a22_brand_col_c4_a21r4_", rowCount = 11)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_brand_col_c4_a21r4_", error = conditionMessage(e))
})

print(paste("Validated:", "a22_brand_col_c4_a21r4_", "-", if(validation_results[["a22_brand_col_c4_a21r4_"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_brand_col_c4_a21r4_"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_brand_col_c5_a21r5_ (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_brand_col_c5_a21r5_"]] <- tryCatch({

  # Row 1: NET - Any attribute (NET)
  if (!("A22r1c5" %in% names(data))) stop("NET component variable 'A22r1c5' not found")
  if (!("A22r2c5" %in% names(data))) stop("NET component variable 'A22r2c5' not found")
  if (!("A22r3c5" %in% names(data))) stop("NET component variable 'A22r3c5' not found")
  if (!("A22r4c5" %in% names(data))) stop("NET component variable 'A22r4c5' not found")
  if (!("A22r5c5" %in% names(data))) stop("NET component variable 'A22r5c5' not found")
  if (!("A22r6c5" %in% names(data))) stop("NET component variable 'A22r6c5' not found")
  if (!("A22r7c5" %in% names(data))) stop("NET component variable 'A22r7c5' not found")
  if (!("A22r8c5" %in% names(data))) stop("NET component variable 'A22r8c5' not found")
  if (!("A22r9c5" %in% names(data))) stop("NET component variable 'A22r9c5' not found")
  if (!("A22r10c5" %in% names(data))) stop("NET component variable 'A22r10c5' not found")
  # Row 2: A22r1c5 == 1
  ...
  list(success = TRUE, tableId = "a22_brand_col_c5_a21r5_", rowCount = 11)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_brand_col_c5_a21r5_", error = conditionMessage(e))
})

print(paste("Validated:", "a22_brand_col_c5_a21r5_", "-", if(validation_results[["a22_brand_col_c5_a21r5_"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_brand_col_c5_a21r5_"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_brand_col_c6_a21r6_ (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_brand_col_c6_a21r6_"]] <- tryCatch({

  # Row 1: NET - Any attribute (NET)
  if (!("A22r1c6" %in% names(data))) stop("NET component variable 'A22r1c6' not found")
  if (!("A22r2c6" %in% names(data))) stop("NET component variable 'A22r2c6' not found")
  if (!("A22r3c6" %in% names(data))) stop("NET component variable 'A22r3c6' not found")
  if (!("A22r4c6" %in% names(data))) stop("NET component variable 'A22r4c6' not found")
  if (!("A22r5c6" %in% names(data))) stop("NET component variable 'A22r5c6' not found")
  if (!("A22r6c6" %in% names(data))) stop("NET component variable 'A22r6c6' not found")
  if (!("A22r7c6" %in% names(data))) stop("NET component variable 'A22r7c6' not found")
  if (!("A22r8c6" %in% names(data))) stop("NET component variable 'A22r8c6' not found")
  if (!("A22r9c6" %in% names(data))) stop("NET component variable 'A22r9c6' not found")
  if (!("A22r10c6" %in% names(data))) stop("NET component variable 'A22r10c6' not found")
  # Row 2: A22r1c6 == 1
  ...
  list(success = TRUE, tableId = "a22_brand_col_c6_a21r6_", rowCount = 11)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_brand_col_c6_a21r6_", error = conditionMessage(e))
})

print(paste("Validated:", "a22_brand_col_c6_a21r6_", "-", if(validation_results[["a22_brand_col_c6_a21r6_"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_brand_col_c6_a21r6_"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_brand_col_c7_a21r7_ (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_brand_col_c7_a21r7_"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_brand_col_c7_a21r7_", rowCount = 10)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_brand_col_c7_a21r7_", error = conditionMessage(e))
})

print(paste("Validated:", "a22_brand_col_c7_a21r7_", "-", if(validation_results[["a22_brand_col_c7_a21r7_"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_brand_col_c7_a21r7_"]]$error)))
...
validation_results[["c3"]] <- tryCatch({
  ...
  # Row 8: NET - Not in labor force (NET)
  if (!("C3r1" %in% names(data))) stop("NET component variable 'C3r1' not found")
  if (!("C3r5" %in% names(data))) stop("NET component variable 'C3r5' not found")
  if (!("C3r8" %in% names(data))) stop("NET component variable 'C3r8' not found")
  if (!("C3r9" %in% names(data))) stop("NET component variable 'C3r9' not found")
  # Row 9: C3r1 == 1
  ...
  list(success = TRUE, tableId = "c3", rowCount = 14)
...
# -----------------------------------------------------------------------------
# Table: a13b_1 (frequency) [loop: stacked_loop_1]
# -----------------------------------------------------------------------------

validation_results[["a13b_1"]] <- tryCatch({

  # Row 1: NET - Any other drinks (NET)
  if (!("A13br1" %in% names(stacked_loop_1))) stop("NET component variable 'A13br1' not found")
  if (!("A13br2" %in% names(stacked_loop_1))) stop("NET component variable 'A13br2' not found")
  if (!("A13br3" %in% names(stacked_loop_1))) stop("NET component variable 'A13br3' not found")
  if (!("A13br4" %in% names(stacked_loop_1))) stop("NET component variable 'A13br4' not found")
  if (!("A13br5" %in% names(stacked_loop_1))) stop("NET component variable 'A13br5' not found")
  # Row 2: A13br1 == 1
  if (!("A13br1" %in% names(stacked_loop_1))) stop("Variable 'A13br1' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A13br1"]]) == 1, na.rm = TRUE)
  # Row 3: A13br2 == 1
  if (!("A13br2" %in% names(stacked_loop_1))) stop("Variable 'A13br2' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A13br2"]]) == 1, na.rm = TRUE)
  # Row 4: A13br3 == 1
  if (!("A13br3" %in% names(stacked_loop_1))) stop("Variable 'A13br3' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A13br3"]]) == 1, na.rm = TRUE)
  # Row 5: A13br4 == 1
  if (!("A13br4" %in% names(stacked_loop_1))) stop("Variable 'A13br4' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A13br4"]]) == 1, na.rm = TRUE)
  # Row 6: A13br5 == 1
  if (!("A13br5" %in% names(stacked_loop_1))) stop("Variable 'A13br5' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A13br5"]]) == 1, na.rm = TRUE)
...
validation_results[["a14a_1"]] <- tryCatch({
  ...
  test_val <- sum(as.numeric(data[["A14a_1"]]) %in% c(1, 2), na.rm = TRUE)
  # Row 2: A14a_1 == 1
  if (!("A14a_1" %in% names(data))) stop("Variable 'A14a_1' not found")
  ...
  list(success = TRUE, tableId = "a14a_1", rowCount = 5)
...
validation_results[["a14a_2"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a14a_2", rowCount = 4)
...
validation_results[["a14b_2"]] <- tryCatch({
  ...
  # Row 7: A14b_2 == 5,6
  if (!("A14b_2" %in% names(data))) stop("Variable 'A14b_2' not found")
  test_val <- sum(as.numeric(data[["A14b_2"]]) %in% c(5, 6), na.rm = TRUE)
  # Row 8: A14b_2 == 5
  if (!("A14b_2" %in% names(data))) stop("Variable 'A14b_2' not found")
  ...
  # Row 10: A14b_2 == 7,8,9
  if (!("A14b_2" %in% names(data))) stop("Variable 'A14b_2' not found")
  test_val <- sum(as.numeric(data[["A14b_2"]]) %in% c(7, 8, 9), na.rm = TRUE)
  # Row 11: A14b_2 == 7
  if (!("A14b_2" %in% names(data))) stop("Variable 'A14b_2' not found")
  ...
  list(success = TRUE, tableId = "a14b_2", rowCount = 16)
...
# -----------------------------------------------------------------------------
# Table: a16_1 (frequency) [loop: stacked_loop_1]
# -----------------------------------------------------------------------------

validation_results[["a16_1"]] <- tryCatch({

  # Row 1: NET - Any purchase reason (NET)
  if (!("A16r1" %in% names(stacked_loop_1))) stop("NET component variable 'A16r1' not found")
  if (!("A16r2" %in% names(stacked_loop_1))) stop("NET component variable 'A16r2' not found")
  if (!("A16r3" %in% names(stacked_loop_1))) stop("NET component variable 'A16r3' not found")
  if (!("A16r4" %in% names(stacked_loop_1))) stop("NET component variable 'A16r4' not found")
  if (!("A16r5" %in% names(stacked_loop_1))) stop("NET component variable 'A16r5' not found")
  if (!("A16r6" %in% names(stacked_loop_1))) stop("NET component variable 'A16r6' not found")
  if (!("A16r7" %in% names(stacked_loop_1))) stop("NET component variable 'A16r7' not found")
  if (!("A16r8" %in% names(stacked_loop_1))) stop("NET component variable 'A16r8' not found")
  if (!("A16r9" %in% names(stacked_loop_1))) stop("NET component variable 'A16r9' not found")
  if (!("A16r10" %in% names(stacked_loop_1))) stop("NET component variable 'A16r10' not found")
  # Row 2: A16r1 == 1
  if (!("A16r1" %in% names(stacked_loop_1))) stop("Variable 'A16r1' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r1"]]) == 1, na.rm = TRUE)
  # Row 3: A16r2 == 1
  if (!("A16r2" %in% names(stacked_loop_1))) stop("Variable 'A16r2' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r2"]]) == 1, na.rm = TRUE)
  # Row 4: A16r3 == 1
  if (!("A16r3" %in% names(stacked_loop_1))) stop("Variable 'A16r3' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r3"]]) == 1, na.rm = TRUE)
  # Row 5: A16r4 == 1
  if (!("A16r4" %in% names(stacked_loop_1))) stop("Variable 'A16r4' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r4"]]) == 1, na.rm = TRUE)
  # Row 6: A16r5 == 1
  if (!("A16r5" %in% names(stacked_loop_1))) stop("Variable 'A16r5' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r5"]]) == 1, na.rm = TRUE)
  # Row 7: A16r6 == 1
  if (!("A16r6" %in% names(stacked_loop_1))) stop("Variable 'A16r6' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r6"]]) == 1, na.rm = TRUE)
  # Row 8: A16r7 == 1
  if (!("A16r7" %in% names(stacked_loop_1))) stop("Variable 'A16r7' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r7"]]) == 1, na.rm = TRUE)
  # Row 9: A16r8 == 1
  if (!("A16r8" %in% names(stacked_loop_1))) stop("Variable 'A16r8' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r8"]]) == 1, na.rm = TRUE)
  # Row 10: A16r9 == 1
  if (!("A16r9" %in% names(stacked_loop_1))) stop("Variable 'A16r9' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r9"]]) == 1, na.rm = TRUE)
  # Row 11: A16r10 == 1
  if (!("A16r10" %in% names(stacked_loop_1))) stop("Variable 'A16r10' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A16r10"]]) == 1, na.rm = TRUE)
...
validation_results[["a17_1"]] <- tryCatch({
  ...
  # Row 1: A17r1 == 1
  if (!("A17r1" %in% names(stacked_loop_1))) stop("Variable 'A17r1' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A17r1"]]) == 1, na.rm = TRUE)
  # Row 2: A17r2 == 1
  if (!("A17r2" %in% names(stacked_loop_1))) stop("Variable 'A17r2' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A17r2"]]) == 1, na.rm = TRUE)
  # Row 3: A17r3 == 1
  if (!("A17r3" %in% names(stacked_loop_1))) stop("Variable 'A17r3' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A17r3"]]) == 1, na.rm = TRUE)
  # Row 4: A17r4 == 1
  if (!("A17r4" %in% names(stacked_loop_1))) stop("Variable 'A17r4' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A17r4"]]) == 1, na.rm = TRUE)
  # Row 5: A17r5 == 1
  if (!("A17r5" %in% names(stacked_loop_1))) stop("Variable 'A17r5' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A17r5"]]) == 1, na.rm = TRUE)
  # Row 6: A17r6 == 1
  if (!("A17r6" %in% names(stacked_loop_1))) stop("Variable 'A17r6' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A17r6"]]) == 1, na.rm = TRUE)
  # Row 7: A17r7 == 1
  if (!("A17r7" %in% names(stacked_loop_1))) stop("Variable 'A17r7' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A17r7"]]) == 1, na.rm = TRUE)
  # Row 8: A17r8 == 1
  if (!("A17r8" %in% names(stacked_loop_1))) stop("Variable 'A17r8' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A17r8"]]) == 1, na.rm = TRUE)
  # Row 9: A17r9 == 1
  if (!("A17r9" %in% names(stacked_loop_1))) stop("Variable 'A17r9' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A17r9"]]) == 1, na.rm = TRUE)

  list(success = TRUE, tableId = "a17_1", rowCount = 9)
...
validation_results[["a19_1"]] <- tryCatch({
  ...
  if (!("A19r1" %in% names(stacked_loop_1))) stop("NET component variable 'A19r1' not found")
  if (!("A19r2" %in% names(stacked_loop_1))) stop("NET component variable 'A19r2' not found")
  if (!("A19r3" %in% names(stacked_loop_1))) stop("NET component variable 'A19r3' not found")
  if (!("A19r4" %in% names(stacked_loop_1))) stop("NET component variable 'A19r4' not found")
  if (!("A19r5" %in% names(stacked_loop_1))) stop("NET component variable 'A19r5' not found")
  if (!("A19r6" %in% names(stacked_loop_1))) stop("NET component variable 'A19r6' not found")
  if (!("A19r7" %in% names(stacked_loop_1))) stop("NET component variable 'A19r7' not found")
  if (!("A19r8" %in% names(stacked_loop_1))) stop("NET component variable 'A19r8' not found")
  if (!("A19r9" %in% names(stacked_loop_1))) stop("NET component variable 'A19r9' not found")
  if (!("A19r10" %in% names(stacked_loop_1))) stop("NET component variable 'A19r10' not found")
  if (!("A19r11" %in% names(stacked_loop_1))) stop("NET component variable 'A19r11' not found")
  # Row 2: A19r1 == 1
  if (!("A19r1" %in% names(stacked_loop_1))) stop("Variable 'A19r1' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r1"]]) == 1, na.rm = TRUE)
  # Row 3: A19r2 == 1
  if (!("A19r2" %in% names(stacked_loop_1))) stop("Variable 'A19r2' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r2"]]) == 1, na.rm = TRUE)
  # Row 4: A19r3 == 1
  if (!("A19r3" %in% names(stacked_loop_1))) stop("Variable 'A19r3' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r3"]]) == 1, na.rm = TRUE)
  # Row 5: A19r4 == 1
  if (!("A19r4" %in% names(stacked_loop_1))) stop("Variable 'A19r4' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r4"]]) == 1, na.rm = TRUE)
  # Row 6: A19r5 == 1
  if (!("A19r5" %in% names(stacked_loop_1))) stop("Variable 'A19r5' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r5"]]) == 1, na.rm = TRUE)
  # Row 7: A19r6 == 1
  if (!("A19r6" %in% names(stacked_loop_1))) stop("Variable 'A19r6' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r6"]]) == 1, na.rm = TRUE)
  # Row 8: A19r7 == 1
  if (!("A19r7" %in% names(stacked_loop_1))) stop("Variable 'A19r7' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r7"]]) == 1, na.rm = TRUE)
  # Row 9: A19r8 == 1
  if (!("A19r8" %in% names(stacked_loop_1))) stop("Variable 'A19r8' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r8"]]) == 1, na.rm = TRUE)
  # Row 10: A19r9 == 1
  if (!("A19r9" %in% names(stacked_loop_1))) stop("Variable 'A19r9' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r9"]]) == 1, na.rm = TRUE)
  # Row 11: A19r10 == 1
  if (!("A19r10" %in% names(stacked_loop_1))) stop("Variable 'A19r10' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r10"]]) == 1, na.rm = TRUE)
  # Row 12: A19r11 == 1
  if (!("A19r11" %in% names(stacked_loop_1))) stop("Variable 'A19r11' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r11"]]) == 1, na.rm = TRUE)
  # Row 13: A19r12 == 1
  if (!("A19r12" %in% names(stacked_loop_1))) stop("Variable 'A19r12' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A19r12"]]) == 1, na.rm = TRUE)

  list(success = TRUE, tableId = "a19_1", rowCount = 13)
...
validation_results[["a7_1"]] <- tryCatch({
  ...
  # Row 1: NET - Any substance (NET)
  if (!("A7r1" %in% names(stacked_loop_1))) stop("NET component variable 'A7r1' not found")
  if (!("A7r2" %in% names(stacked_loop_1))) stop("NET component variable 'A7r2' not found")
  if (!("A7r3" %in% names(stacked_loop_1))) stop("NET component variable 'A7r3' not found")
  if (!("A7r4" %in% names(stacked_loop_1))) stop("NET component variable 'A7r4' not found")
  if (!("A7r5" %in% names(stacked_loop_1))) stop("NET component variable 'A7r5' not found")
  # Row 2: A7r1 == 1
  if (!("A7r1" %in% names(stacked_loop_1))) stop("Variable 'A7r1' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A7r1"]]) == 1, na.rm = TRUE)
  # Row 3: A7r2 == 1
  if (!("A7r2" %in% names(stacked_loop_1))) stop("Variable 'A7r2' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A7r2"]]) == 1, na.rm = TRUE)
  # Row 4: A7r3 == 1
  if (!("A7r3" %in% names(stacked_loop_1))) stop("Variable 'A7r3' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A7r3"]]) == 1, na.rm = TRUE)
  # Row 5: A7r4 == 1
  if (!("A7r4" %in% names(stacked_loop_1))) stop("Variable 'A7r4' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A7r4"]]) == 1, na.rm = TRUE)
  # Row 6: A7r5 == 1
  if (!("A7r5" %in% names(stacked_loop_1))) stop("Variable 'A7r5' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A7r5"]]) == 1, na.rm = TRUE)
  # Row 7: A7r6 == 1
  if (!("A7r6" %in% names(stacked_loop_1))) stop("Variable 'A7r6' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A7r6"]]) == 1, na.rm = TRUE)
...
validation_results[["a9_1"]] <- tryCatch({
  ...
  # Row 1: A9r1 == 1
  if (!("A9r1" %in% names(stacked_loop_1))) stop("Variable 'A9r1' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A9r1"]]) == 1, na.rm = TRUE)
  # Row 2: NET - Any companion (NET)
  if (!("A9r2" %in% names(stacked_loop_1))) stop("NET component variable 'A9r2' not found")
  if (!("A9r3" %in% names(stacked_loop_1))) stop("NET component variable 'A9r3' not found")
  if (!("A9r4" %in% names(stacked_loop_1))) stop("NET component variable 'A9r4' not found")
  if (!("A9r5" %in% names(stacked_loop_1))) stop("NET component variable 'A9r5' not found")
  if (!("A9r6" %in% names(stacked_loop_1))) stop("NET component variable 'A9r6' not found")
  if (!("A9r7" %in% names(stacked_loop_1))) stop("NET component variable 'A9r7' not found")
  # Row 3: A9r2 == 1
  if (!("A9r2" %in% names(stacked_loop_1))) stop("Variable 'A9r2' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A9r2"]]) == 1, na.rm = TRUE)
  # Row 4: A9r3 == 1
  if (!("A9r3" %in% names(stacked_loop_1))) stop("Variable 'A9r3' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A9r3"]]) == 1, na.rm = TRUE)
  # Row 5: A9r4 == 1
  if (!("A9r4" %in% names(stacked_loop_1))) stop("Variable 'A9r4' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A9r4"]]) == 1, na.rm = TRUE)
  # Row 6: A9r5 == 1
  if (!("A9r5" %in% names(stacked_loop_1))) stop("Variable 'A9r5' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A9r5"]]) == 1, na.rm = TRUE)
  # Row 7: A9r6 == 1
  if (!("A9r6" %in% names(stacked_loop_1))) stop("Variable 'A9r6' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A9r6"]]) == 1, na.rm = TRUE)
  # Row 8: A9r7 == 1
  if (!("A9r7" %in% names(stacked_loop_1))) stop("Variable 'A9r7' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A9r7"]]) == 1, na.rm = TRUE)
