...
# Generated: 2026-02-07T07:05:04.151Z
# Tables to validate: 60
...
# -----------------------------------------------------------------------------
# Table: s2_bins (frequency)
# -----------------------------------------------------------------------------

validation_results[["s2_bins"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s2_bins", rowCount = 6)

}, error = function(e) {
  list(success = FALSE, tableId = "s2_bins", error = conditionMessage(e))
})

print(paste("Validated:", "s2_bins", "-", if(validation_results[["s2_bins"]]$success) "PASS" else paste("FAIL:", validation_results[["s2_bins"]]$error)))
...
validation_results[["s6a"]] <- tryCatch({
  ...
  # Row 1: NET - Any of the listed countries/regions (NET)
...
validation_results[["s7"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s7", rowCount = 6)
...
validation_results[["s8_binned"]] <- tryCatch({
  ...
  # Row 4: S8 == 7-14
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) >= 7 & as.numeric(data[["S8"]]) <= 14, na.rm = TRUE)
  # Row 5: S8 == 15-50
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) >= 15 & as.numeric(data[["S8"]]) <= 50, na.rm = TRUE)
...
validation_results[["s10b"]] <- tryCatch({
  ...
  # Row 2: S10b == 1
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 1, na.rm = TRUE)
  # Row 3: S10b == 2
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 2, na.rm = TRUE)
  # Row 4: S10b == 3
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 3, na.rm = TRUE)
  # Row 5: S10b == 4
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 4, na.rm = TRUE)
  # Row 6: Category header - Status / Image (skip validation)
  # Row 7: S10b == 6
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 6, na.rm = TRUE)
  # Row 8: S10b == 7
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 7, na.rm = TRUE)
  # Row 9: S10b == 8
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 8, na.rm = TRUE)
  # Row 10: S10b == 9
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 9, na.rm = TRUE)
  # Row 11: Category header - Exploration / Discovery (skip validation)
  # Row 12: S10b == 11
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 11, na.rm = TRUE)
  # Row 13: S10b == 12
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 12, na.rm = TRUE)
  # Row 14: S10b == 13
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 13, na.rm = TRUE)
  # Row 15: S10b == 14
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 14, na.rm = TRUE)
  # Row 16: Category header - Celebration (skip validation)
  # Row 17: S10b == 16
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 16, na.rm = TRUE)
  # Row 18: S10b == 17
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 17, na.rm = TRUE)
  # Row 19: S10b == 19
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 19, na.rm = TRUE)
  # Row 20: Category header - Indulgence / Personal Treat (skip validation)
  # Row 21: S10b == 21
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 21, na.rm = TRUE)
  # Row 22: S10b == 24
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 24, na.rm = TRUE)
  # Row 23: S10b == 40
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 40, na.rm = TRUE)
  # Row 24: Category header - Escape / Relief (skip validation)
  # Row 25: S10b == 26
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 26, na.rm = TRUE)
  # Row 26: S10b == 27
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 27, na.rm = TRUE)
  # Row 27: S10b == 28
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 28, na.rm = TRUE)
  # Row 28: S10b == 29
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 29, na.rm = TRUE)
  # Row 29: Category header - Performance / Social Confidence (skip validation)
  # Row 30: S10b == 31
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 31, na.rm = TRUE)
  # Row 31: S10b == 32
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 32, na.rm = TRUE)
  # Row 32: S10b == 34
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 34, na.rm = TRUE)
  # Row 33: Category header - Tradition (skip validation)
  # Row 34: S10b == 36
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 36, na.rm = TRUE)
  # Row 35: S10b == 37
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 37, na.rm = TRUE)
  # Row 36: S10b == 38
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 38, na.rm = TRUE)
  # Row 37: S10b == 39
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 39, na.rm = TRUE)
  # Row 38: Category header - Other (Specify) (skip validation)
  # Row 39: S10b == 100
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 100, na.rm = TRUE)
  # Row 40: S10b == 101
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 101, na.rm = TRUE)
  # Row 41: S10b == 102
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 102, na.rm = TRUE)
  # Row 42: S10b == 103
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 103, na.rm = TRUE)
  # Row 43: S10b == 104
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 104, na.rm = TRUE)
  # Row 44: S10b == 105
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 105, na.rm = TRUE)
  # Row 45: S10b == 106
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 106, na.rm = TRUE)
  # Row 46: S10b == 107
  if (!("S10b" %in% names(Location 1 / Location 2))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(Location 1 / Location 2[["S10b"]]) == 107, na.rm = TRUE)

  list(success = TRUE, tableId = "s10b", rowCount = 46)
...
validation_results[["s11b"]] <- tryCatch({
  ...
  # Row 23: Category header - Escape / Relief / Mindset (skip validation)
  # Row 24: S11b == 26
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 28: Category header - Performance / Social Confidence (skip validation)
  # Row 29: S11b == 31
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  ...
  # Row 32: Category header - Tradition / Family (skip validation)
  # Row 33: S11b == 36
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
...
validation_results[["a2"]] <- tryCatch({
  ...
  # Row 5: A2 == 4,5,6,7
  if (!("A2" %in% names(stacked_loop_1))) stop("Variable 'A2' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A2"]]) %in% c(4, 5, 6, 7), na.rm = TRUE)
  # Row 6: A2 == 4
  if (!("A2" %in% names(stacked_loop_1))) stop("Variable 'A2' not found")
...
validation_results[["a4"]] <- tryCatch({
  ...
  # Row 16: A4 == 7,8,9,10,11,12,13,14
  if (!("A4" %in% names(stacked_loop_1))) stop("Variable 'A4' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A4"]]) %in% c(7, 8, 9, 10, 11, 12, 13, 14), na.rm = TRUE)
  # Row 17: A4 == 15
  if (!("A4" %in% names(stacked_loop_1))) stop("Variable 'A4' not found")
...
# -----------------------------------------------------------------------------
# Table: a10_dist_bins (frequency) [loop: stacked_loop_1]
# -----------------------------------------------------------------------------

validation_results[["a10_dist_bins"]] <- tryCatch({

  # Row 1: Category header - Number of people (binned) (skip validation)
  # Row 2: A10 == 2
  if (!("A10" %in% names(stacked_loop_1))) stop("Variable 'A10' not found")
  ...
  # Row 4: A10 == 5-6
  if (!("A10" %in% names(stacked_loop_1))) stop("Variable 'A10' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A10"]]) >= 5 & as.numeric(stacked_loop_1[["A10"]]) <= 6, na.rm = TRUE)
  # Row 5: A10 == 7-10
  if (!("A10" %in% names(stacked_loop_1))) stop("Variable 'A10' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A10"]]) >= 7 & as.numeric(stacked_loop_1[["A10"]]) <= 10, na.rm = TRUE)
  # Row 6: A10 == 11-30
  if (!("A10" %in% names(stacked_loop_1))) stop("Variable 'A10' not found")
  test_val <- sum(as.numeric(stacked_loop_1[["A10"]]) >= 11 & as.numeric(stacked_loop_1[["A10"]]) <= 30, na.rm = TRUE)

  list(success = TRUE, tableId = "a10_dist_bins", rowCount = 6)

}, error = function(e) {
  list(success = FALSE, tableId = "a10_dist_bins", error = conditionMessage(e))
})

print(paste("Validated:", "a10_dist_bins", "-", if(validation_results[["a10_dist_bins"]]$success) "PASS" else paste("FAIL:", validation_results[["a10_dist_bins"]]$error)))
...
validation_results[["a21"]] <- tryCatch({
  ...
  # Row 1: NET - Any of the listed brands (NET)
...
# -----------------------------------------------------------------------------
# Table: a22_attr_approachable (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_approachable"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_approachable", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_approachable", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_approachable", "-", if(validation_results[["a22_attr_approachable"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_approachable"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_attr_authentic (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_authentic"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_authentic", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_authentic", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_authentic", "-", if(validation_results[["a22_attr_authentic"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_authentic"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_attr_bold (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_bold"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_bold", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_bold", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_bold", "-", if(validation_results[["a22_attr_bold"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_bold"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_attr_down_to_earth (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_down_to_earth"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_down_to_earth", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_down_to_earth", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_down_to_earth", "-", if(validation_results[["a22_attr_down_to_earth"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_down_to_earth"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_attr_edgy (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_edgy"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_edgy", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_edgy", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_edgy", "-", if(validation_results[["a22_attr_edgy"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_edgy"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_attr_generous (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_generous"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_generous", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_generous", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_generous", "-", if(validation_results[["a22_attr_generous"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_generous"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_attr_independent (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_independent"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_independent", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_independent", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_independent", "-", if(validation_results[["a22_attr_independent"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_independent"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_attr_premium (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_premium"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_premium", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_premium", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_premium", "-", if(validation_results[["a22_attr_premium"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_premium"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_attr_reliable (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_reliable"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_reliable", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_reliable", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_reliable", "-", if(validation_results[["a22_attr_reliable"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_reliable"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_attr_sophisticated_refined (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_attr_sophisticated_refined"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a22_attr_sophisticated_refined", rowCount = 7)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_attr_sophisticated_refined", error = conditionMessage(e))
})

print(paste("Validated:", "a22_attr_sophisticated_refined", "-", if(validation_results[["a22_attr_sophisticated_refined"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_attr_sophisticated_refined"]]$error)))
...
validation_results[["a13a_2"]] <- tryCatch({
  ...
  # Row 1: A13a_2 == 1
  if (!("A13a_2" %in% names(Location 2))) stop("Variable 'A13a_2' not found")
  test_val <- sum(as.numeric(Location 2[["A13a_2"]]) == 1, na.rm = TRUE)
  # Row 2: A13a_2 == 2
  if (!("A13a_2" %in% names(Location 2))) stop("Variable 'A13a_2' not found")
  test_val <- sum(as.numeric(Location 2[["A13a_2"]]) == 2, na.rm = TRUE)
...
validation_results[["a14a_1"]] <- tryCatch({
  ...
  # Row 2: NET - Not purchased by respondent (NET)
  if (!("A14a_1" %in% names(data))) stop("NET component variable 'A14a_1' not found")
  if (!("A14a_1" %in% names(data))) stop("NET component variable 'A14a_1' not found")
  if (!("A14a_1" %in% names(data))) stop("NET component variable 'A14a_1' not found")
  # Row 3: A14a_1 == 2
  if (!("A14a_1" %in% names(data))) stop("Variable 'A14a_1' not found")
...
validation_results[["a14b_1"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a14b_1", rowCount = 15)
...
validation_results[["a17_1"]] <- tryCatch({
  ...
  if (!("A17r1" %in% names(stacked_loop_1))) stop("NET component variable 'A17r1' not found")
  if (!("A17r2" %in% names(stacked_loop_1))) stop("NET component variable 'A17r2' not found")
  if (!("A17r3" %in% names(stacked_loop_1))) stop("NET component variable 'A17r3' not found")
  if (!("A17r4" %in% names(stacked_loop_1))) stop("NET component variable 'A17r4' not found")
  if (!("A17r5" %in% names(stacked_loop_1))) stop("NET component variable 'A17r5' not found")
  if (!("A17r6" %in% names(stacked_loop_1))) stop("NET component variable 'A17r6' not found")
  if (!("A17r7" %in% names(stacked_loop_1))) stop("NET component variable 'A17r7' not found")
  if (!("A17r8" %in% names(stacked_loop_1))) stop("NET component variable 'A17r8' not found")
  if (!("A17r9" %in% names(stacked_loop_1))) stop("NET component variable 'A17r9' not found")
  # Row 2: A17r1 == 1
...
validation_results[["a7_1"]] <- tryCatch({
  ...
  # Row 1: NET - Any of the substances (NET)
