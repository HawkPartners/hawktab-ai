...
# Generated: 2026-02-08T07:38:07.587Z
...
# -----------------------------------------------------------------------------
# Table: a13b_1 (frequency) [DERIVED]
...
lpv_Needs_State_na_count <- lpv_Needs_State_total - sum(sapply(lpv_Needs_State_masks, function(m) sum(!is.na(m))))
...
output <- list(
  metadata = list(
    generatedAt = "2026-02-08T07:38:07.593Z",
    tableCount = 61,
    cutCount = 20,
