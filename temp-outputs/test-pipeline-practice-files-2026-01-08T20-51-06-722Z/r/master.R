...
# Session: test-pipeline-practice-files-2026-01-08T20-51-06-722Z
# Generated: 2026-01-08T21:37:55.882Z
# Tables: 54
# Cuts: 21
...
# -----------------------------------------------------------------------------
# Table: s1 (frequency)
# Title: S1 - Consent to proceed (reporting of adverse events)
# Rows: 2
# Source: s1
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_s2b$data[[cut_name]][["S2b_row_2"]] <- list(
      label = "Advanced Practice Provider (NP/PA) (NET)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
...
# Skipping excluded table: s5_employment_affiliations (Screener question with multiple 'TERMINATE' response options (S5r1–S5r6). Only 'None of these' (S5r7) qualifies to continue. Per termination-handling rules, exclude this screener from main outputs and keep it in the reference/technical appendix.)

# -----------------------------------------------------------------------------
# Table: s6 (mean_rows)
# Title: S6 - How many years have you been in clinical practice (post residency/training)?
# Rows: 1
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Table: s8_percent_by_activity (mean_rows)
# Title: S8 - Percentage of professional time spent on activities (mean, median, std dev)
# Rows: 4
# -----------------------------------------------------------------------------

table_s8_percent_by_activity <- list(
  tableId = "s8_percent_by_activity",
  title = "S8 - Percentage of professional time spent on activities (mean, median, std dev)",
  tableType = "mean_rows",
  hints = c(),
  isDerived = FALSE,
...
for (cut_name in names(cuts)) {
  cut_data <- apply_cut(data, cuts[[cut_name]])
  table_s8_percent_by_activity$data[[cut_name]] <- list()
  table_s8_percent_by_activity$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_s8_percent_by_activity$data[[cut_name]][["S8r1"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_s8_percent_by_activity$data[[cut_name]][["S8r2"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_s8_percent_by_activity$data[[cut_name]][["S8r3"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_s8_percent_by_activity$data[[cut_name]][["S8r4"]] <- list(
...
all_tables[["s8_percent_by_activity"]] <- table_s8_percent_by_activity
print(paste("Generated mean_rows table: s8_percent_by_activity"))

# -----------------------------------------------------------------------------
# Table: s9 (frequency)
# Title: S9 - Which setting represents where you spend most of your professional time?
# Rows: 8
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Table: s10 (mean_rows)
# Title: S10 - Number of adult patients (18+) personally managed per month
# Rows: 1
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Table: s12 (mean_rows)
# Title: S12 - Number of patients with a prior cardiac event, by time since event
# Rows: 4
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a1$data[[cut_name]][["A1r4_row_7"]] <- list(
      label = "Nexletol (bempedoic acid) or Nexlizet (bempedoic acid and ezetimibe) - As an adjunct to diet, alone or in combination with other LDL-C-lowering therapies, in adults with primary hyperlipidemia",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_a1$data[[cut_name]][["A1r4_row_8"]] <- list(
      label = "Nexletol (bempedoic acid) or Nexlizet (bempedoic acid and ezetimibe) - As an adjunct to diet and statin therapy for the treatment of adults with primary hyperlipidemia",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
# -----------------------------------------------------------------------------
# Table: a2a (frequency)
# Title: A2a - Current post-ACS guideline recommendation regarding lipid-lowering
# Rows: 3
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Table: a2b (frequency)
# Title: A2b - And to the best of your knowledge, which of the following best describes the current post-ACS guideline recommendation specific to lipid-lowering therapy?
# Rows: 3
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a2b$data[[cut_name]][["A2b_row_1"]] <- list(
      label = "Recommend a statin first, add or switch to ezetimibe if needed, then add or switch to a PCSK9i if needed",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_a2b$data[[cut_name]][["A2b_row_2"]] <- list(
      label = "Recommend a statin + ezetimibe first, add or switch to a PCSK9i if needed",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
# -----------------------------------------------------------------------------
# Table: a3 (mean_rows)
# Title: A3 - Number prescribed (of last 100 patients) by therapy
# Rows: 7
# -----------------------------------------------------------------------------
...
# Title: A3a - % receiving each therapy in addition to a statin vs without a statin (mean / median / stddev)
# Rows: 10
# Source: a3a_mean
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  table_a3a_mean$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
...
# Title: A3b - % prescribed without a statin (by treatment and timing)
# Rows: 10
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_A3b_mean_rows$data[[cut_name]][["A3br5c1"]] <- list(
      label = "Nexletol (bempedoic acid) or Nexlizet (bempedoic acid and ezetimibe) — Before any other lipid-lowering therapy (i.e., first line)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
...
# Title: A4 - Mean # prescribed per treatment (LAST 100 and NEXT 100 patients with uncontrolled LDL-C)
# Rows: 14
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows$data[[cut_name]][["A4r6c1"]] <- list(
      label = "Nexletol (bempedoic acid) or Nexlizet (bempedoic acid and ezetimibe) — LAST 100",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows$data[[cut_name]][["A4r6c2"]] <- list(
      label = "Nexletol (bempedoic acid) or Nexlizet (bempedoic acid and ezetimibe) — NEXT 100",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
...
# -----------------------------------------------------------------------------
# Table: a4_mean_rows_last (mean_rows) [DERIVED]
# Title: A4 - Mean # prescribed per treatment (LAST 100 patients with uncontrolled LDL-C)
# Rows: 7
# Source: a4_mean_rows
# -----------------------------------------------------------------------------

table_a4_mean_rows_last <- list(
  tableId = "a4_mean_rows_last",
  title = "A4 - Mean # prescribed per treatment (LAST 100 patients with uncontrolled LDL-C)",
  tableType = "mean_rows",
  hints = c(),
  isDerived = TRUE,
...
for (cut_name in names(cuts)) {
  cut_data <- apply_cut(data, cuts[[cut_name]])
  table_a4_mean_rows_last$data[[cut_name]] <- list()
  table_a4_mean_rows_last$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_last$data[[cut_name]][["A4r1c1"]] <- list(
      label = "Statin only (i.e., no additional therapy)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_last$data[[cut_name]][["A4r2c1"]] <- list(
      label = "Leqvio (inclisiran)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_last$data[[cut_name]][["A4r3c1"]] <- list(
      label = "Praluent (alirocumab)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_last$data[[cut_name]][["A4r4c1"]] <- list(
      label = "Repatha (evolocumab)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_last$data[[cut_name]][["A4r5c1"]] <- list(
      label = "Zetia (ezetimibe) or generic ezetimibe",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_last$data[[cut_name]][["A4r6c1"]] <- list(
      label = "Nexletol (bempedoic acid) or Nexlizet (bempedoic acid and ezetimibe)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_last$data[[cut_name]][["A4r7c1"]] <- list(
      label = "Other",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
...
all_tables[["a4_mean_rows_last"]] <- table_a4_mean_rows_last
print(paste("Generated mean_rows table: a4_mean_rows_last"))

# -----------------------------------------------------------------------------
# Table: a4_mean_rows_next (mean_rows) [DERIVED]
# Title: A4 - Mean # prescribed per treatment (NEXT 100 patients with uncontrolled LDL-C)
# Rows: 7
# Source: a4_mean_rows
# -----------------------------------------------------------------------------

table_a4_mean_rows_next <- list(
  tableId = "a4_mean_rows_next",
  title = "A4 - Mean # prescribed per treatment (NEXT 100 patients with uncontrolled LDL-C)",
  tableType = "mean_rows",
  hints = c(),
  isDerived = TRUE,
...
for (cut_name in names(cuts)) {
  cut_data <- apply_cut(data, cuts[[cut_name]])
  table_a4_mean_rows_next$data[[cut_name]] <- list()
  table_a4_mean_rows_next$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_next$data[[cut_name]][["A4r1c2"]] <- list(
      label = "Statin only (i.e., no additional therapy)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_next$data[[cut_name]][["A4r2c2"]] <- list(
      label = "Leqvio (inclisiran)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_next$data[[cut_name]][["A4r3c2"]] <- list(
      label = "Praluent (alirocumab)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_next$data[[cut_name]][["A4r4c2"]] <- list(
      label = "Repatha (evolocumab)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_next$data[[cut_name]][["A4r5c2"]] <- list(
      label = "Zetia (ezetimibe) or generic ezetimibe",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_next$data[[cut_name]][["A4r6c2"]] <- list(
      label = "Nexletol (bempedoic acid) or Nexlizet (bempedoic acid and ezetimibe)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_a4_mean_rows_next$data[[cut_name]][["A4r7c2"]] <- list(
      label = "Other",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
...
all_tables[["a4_mean_rows_next"]] <- table_a4_mean_rows_next
print(paste("Generated mean_rows table: a4_mean_rows_next"))

# -----------------------------------------------------------------------------
# Table: A4a_mean_rows (mean_rows)
# Title: A4a - % of NEXT 100 with Uncontrolled LDL-C (mean/median/std)
# Rows: 10
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_A4a_mean_rows$data[[cut_name]][["A4ar5c1"]] <- list(
      label = "Nexletol / Nexlizet (bempedoic acid) — In addition to a statin",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
...
# -----------------------------------------------------------------------------
# Table: A4b (mean_rows)
# Title: A4b - For treatments prescribed WITHOUT a statin: % Before vs After other lipid‑lowering therapy
# Rows: 10
# Source: A4b
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  cut_data <- apply_cut(data, cuts[[cut_name]])
  table_A4b$data[[cut_name]] <- list()
  table_A4b$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br1c1"]] <- list(
      label = "Leqvio (inclisiran) — % of patients prescribed this therapy WITHOUT a statin: Before any other lipid‑lowering therapy (first line)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br1c2"]] <- list(
      label = "Leqvio (inclisiran) — % of patients prescribed this therapy WITHOUT a statin: After trying another lipid‑lowering therapy",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br2c1"]] <- list(
      label = "Praluent (alirocumab) — % of patients prescribed this therapy WITHOUT a statin: Before any other lipid‑lowering therapy (first line)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br2c2"]] <- list(
      label = "Praluent (alirocumab) — % of patients prescribed this therapy WITHOUT a statin: After trying another lipid‑lowering therapy",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br3c1"]] <- list(
      label = "Repatha (evolocumab) — % of patients prescribed this therapy WITHOUT a statin: Before any other lipid‑lowering therapy (first line)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br3c2"]] <- list(
      label = "Repatha (evolocumab) — % of patients prescribed this therapy WITHOUT a statin: After trying another lipid‑lowering therapy",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br4c1"]] <- list(
      label = "Zetia (ezetimibe) or generic ezetimibe — % of patients prescribed this therapy WITHOUT a statin: Before any other lipid‑lowering therapy (first line)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br4c2"]] <- list(
      label = "Zetia (ezetimibe) or generic ezetimibe — % of patients prescribed this therapy WITHOUT a statin: After trying another lipid‑lowering therapy",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br5c1"]] <- list(
      label = "Nexletol (bempedoic acid) or Nexlizet (bempedoic acid and ezetimibe) — % of patients prescribed this therapy WITHOUT a statin: Before any other lipid‑lowering therapy (first line)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
  ...
  if (!is.null(var_col)) {
    ...
    table_A4b$data[[cut_name]][["A4br5c2"]] <- list(
      label = "Nexletol (bempedoic acid) or Nexlizet (bempedoic acid and ezetimibe) — % of patients prescribed this therapy WITHOUT a statin: After trying another lipid‑lowering therapy",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
...
all_tables[["A4b"]] <- table_A4b
print(paste("Generated mean_rows table: A4b"))
...
# Title: A6 - Items ranked #2 (Which treatment path is your 2nd choice?)
# Rows: 8
# Source: A6_rank2
# -----------------------------------------------------------------------------
...
# Title: A7 - How might being able to use PCSK9 inhibitors with or without statin therapy impact your perceptions and/or prescribing? (Select all that apply)
# Rows: 5
# Source: A7_multi
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_A7_multi$data[[cut_name]][["A7r1_row_1"]] <- list(
      label = "Makes PCSK9 inhibitors easier to get covered by insurance / get patients on the medication",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A7_multi$data[[cut_name]][["A7r3_row_3"]] <- list(
      label = "Enables me to use PCSK9 inhibitors sooner for patients",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
# Title: A8r1 - With established CVD
# Rows: 21
# Source: A8_r1
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r1$data[[cut_name]][["A8r1c1_row_1"]] <- list(
      label = "Very or Extremely likely (T2B)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
...
# Title: A8r2 - With no history of CV events and at high-risk
# Rows: 15
# -----------------------------------------------------------------------------
...
# Title: A8r2 - With no history of CV events and at high-risk (T2B/B2B summary)
# Rows: 21
# Source: A8_r2
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c1_row_2"]] <- list(
      label = "Repatha - Extremely likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c1_row_3"]] <- list(
      label = "Repatha - Very likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c1_row_4"]] <- list(
      label = "Repatha - Somewhat likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c1_row_5"]] <- list(
      label = "Repatha - Unlikely (B2B)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c1_row_6"]] <- list(
      label = "Repatha - Slightly likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c1_row_7"]] <- list(
      label = "Repatha - Not at all likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c2_row_8"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c2_row_9"]] <- list(
      label = "Praluent - Extremely likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c2_row_10"]] <- list(
      label = "Praluent - Very likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c2_row_11"]] <- list(
      label = "Praluent - Somewhat likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c2_row_12"]] <- list(
      label = "Praluent - Unlikely (B2B)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c2_row_13"]] <- list(
      label = "Praluent - Slightly likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c2_row_14"]] <- list(
      label = "Praluent - Not at all likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c3_row_15"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c3_row_16"]] <- list(
      label = "Leqvio - Extremely likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c3_row_17"]] <- list(
      label = "Leqvio - Very likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c3_row_18"]] <- list(
      label = "Leqvio - Somewhat likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c3_row_19"]] <- list(
      label = "Leqvio - Unlikely (B2B)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c3_row_20"]] <- list(
      label = "Leqvio - Slightly likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r2_T2B$data[[cut_name]][["A8r2c3_row_21"]] <- list(
      label = "Leqvio - Not at all likely",
      n = base_n,
      count = count,
      pct = pct,
...
# Title: A8r3 - With no history of CV events and at low-to-medium risk
# Rows: 15
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r3$data[[cut_name]][["A8r3c2_row_6"]] <- list(
      label = "Praluent - Very unlikely/1",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
# Title: A8r4 - Patients who are not known to be compliant on statins
# Rows: 15
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c1_row_1"]] <- list(
      label = "Repatha - Not at all likely (1)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c1_row_2"]] <- list(
      label = "Repatha - Slightly likely (2)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c1_row_3"]] <- list(
      label = "Repatha - Somewhat likely (3)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c1_row_5"]] <- list(
      label = "Repatha - Extremely likely (5)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c2_row_6"]] <- list(
      label = "Praluent - Not at all likely (1)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c2_row_7"]] <- list(
      label = "Praluent - Slightly likely (2)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c2_row_8"]] <- list(
      label = "Praluent - Somewhat likely (3)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c2_row_10"]] <- list(
      label = "Praluent - Extremely likely (5)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c3_row_11"]] <- list(
      label = "Leqvio - Not at all likely (1)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c3_row_12"]] <- list(
      label = "Leqvio - Slightly likely (2)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c3_row_13"]] <- list(
      label = "Leqvio - Somewhat likely (3)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4$data[[cut_name]][["A8r4c3_row_15"]] <- list(
      label = "Leqvio - Extremely likely (5)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
# Title: A8r4 - Patients who are not known to be compliant on statins (T2B / B2B)
# Rows: 21
# Source: A8_r4
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c1_row_2"]] <- list(
      label = "Repatha - Extremely likely (5)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c1_row_3"]] <- list(
      label = "Repatha - Very likely (4)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c1_row_4"]] <- list(
      label = "Repatha - Somewhat likely (3)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c1_row_5"]] <- list(
      label = "Repatha - Unlikely (B2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c1_row_6"]] <- list(
      label = "Repatha - Slightly likely (2)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c1_row_7"]] <- list(
      label = "Repatha - Not at all likely (1)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c2_row_8"]] <- list(
      label = "Praluent - Likely (T2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c2_row_9"]] <- list(
      label = "Praluent - Extremely likely (5)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c2_row_10"]] <- list(
      label = "Praluent - Very likely (4)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c2_row_11"]] <- list(
      label = "Praluent - Somewhat likely (3)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c2_row_12"]] <- list(
      label = "Praluent - Unlikely (B2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c2_row_13"]] <- list(
      label = "Praluent - Slightly likely (2)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c2_row_14"]] <- list(
      label = "Praluent - Not at all likely (1)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c3_row_15"]] <- list(
      label = "Leqvio - Likely (T2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c3_row_16"]] <- list(
      label = "Leqvio - Extremely likely (5)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c3_row_17"]] <- list(
      label = "Leqvio - Very likely (4)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c3_row_18"]] <- list(
      label = "Leqvio - Somewhat likely (3)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c3_row_19"]] <- list(
      label = "Leqvio - Unlikely (B2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c3_row_20"]] <- list(
      label = "Leqvio - Slightly likely (2)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r4_t2b$data[[cut_name]][["A8r4c3_row_21"]] <- list(
      label = "Leqvio - Not at all likely (1)",
      n = base_n,
      count = count,
      pct = pct,
...
# Title: A8r5 - Who are intolerant of statins
# Rows: 15
# -----------------------------------------------------------------------------
...
# Title: A8r5 - Who are intolerant of statins (Top2 / Bottom2 Box)
# Rows: 21
# Source: A8_r5
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c1_row_2"]] <- list(
      label = "Repatha - Extremely likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c1_row_3"]] <- list(
      label = "Repatha - Very likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c1_row_4"]] <- list(
      label = "Repatha - Somewhat likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c1_row_5"]] <- list(
      label = "Repatha - Unlikely (B2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c1_row_6"]] <- list(
      label = "Repatha - Slightly likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c1_row_7"]] <- list(
      label = "Repatha - Not at all likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c2_row_8"]] <- list(
      label = "Praluent - Likely (T2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c2_row_9"]] <- list(
      label = "Praluent - Extremely likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c2_row_10"]] <- list(
      label = "Praluent - Very likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c2_row_11"]] <- list(
      label = "Praluent - Somewhat likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c2_row_12"]] <- list(
      label = "Praluent - Unlikely (B2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c2_row_13"]] <- list(
      label = "Praluent - Slightly likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c2_row_14"]] <- list(
      label = "Praluent - Not at all likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c3_row_15"]] <- list(
      label = "Leqvio - Likely (T2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c3_row_16"]] <- list(
      label = "Leqvio - Extremely likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c3_row_17"]] <- list(
      label = "Leqvio - Very likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c3_row_18"]] <- list(
      label = "Leqvio - Somewhat likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c3_row_19"]] <- list(
      label = "Leqvio - Unlikely (B2B)",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c3_row_20"]] <- list(
      label = "Leqvio - Slightly likely",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A8_r5_t2b$data[[cut_name]][["A8r5c3_row_21"]] <- list(
      label = "Leqvio - Not at all likely",
      n = base_n,
      count = count,
      pct = pct,
...
# -----------------------------------------------------------------------------
# Table: A9_overall (frequency)
# Title: A9 - Issues encountered when prescribing without a statin (by product)
# Rows: 15
# -----------------------------------------------------------------------------

table_A9_overall <- list(
  tableId = "A9_overall",
  title = "A9 - Issues encountered when prescribing without a statin (by product)",
  tableType = "frequency",
  hints = c(),
...
for (cut_name in names(cuts)) {
  cut_data <- apply_cut(data, cuts[[cut_name]])
  table_A9_overall$data[[cut_name]] <- list()
  table_A9_overall$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c1_row_1"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c1_row_2"]] <- list(
      label = "No issues",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c1_row_3"]] <- list(
      label = "Some issues",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c1_row_4"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c1_row_5"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c2_row_6"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c2_row_7"]] <- list(
      label = "No issues",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c2_row_8"]] <- list(
      label = "Some issues",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c2_row_9"]] <- list(
      label = "Significant issues",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c2_row_10"]] <- list(
      label = "Haven't prescribed without a statin",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c3_row_11"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c3_row_12"]] <- list(
      label = "No issues",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c3_row_13"]] <- list(
      label = "Some issues",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c3_row_14"]] <- list(
      label = "Significant issues",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_A9_overall$data[[cut_name]][["A9c3_row_15"]] <- list(
      label = "Haven't prescribed without a statin",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["A9_overall"]] <- table_A9_overall
print(paste("Generated frequency table: A9_overall"))

# -----------------------------------------------------------------------------
# Table: A10_multi_select (frequency)
# Title: A10 - For what reasons are you using PCSK9 inhibitors without a statin today? (Select all that apply)
# Rows: 6
# -----------------------------------------------------------------------------

table_A10_multi_select <- list(
  tableId = "A10_multi_select",
  title = "A10 - For what reasons are you using PCSK9 inhibitors without a statin today? (Select all that apply)",
  tableType = "frequency",
  hints = c(),
  isDerived = FALSE,
...
for (cut_name in names(cuts)) {
  cut_data <- apply_cut(data, cuts[[cut_name]])
  table_A10_multi_select$data[[cut_name]] <- list()
  table_A10_multi_select$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_A10_multi_select$data[[cut_name]][["A10r1_row_1"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A10_multi_select$data[[cut_name]][["A10r2_row_2"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A10_multi_select$data[[cut_name]][["A10r3_row_3"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A10_multi_select$data[[cut_name]][["A10r4_row_4"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A10_multi_select$data[[cut_name]][["A10r5_row_5"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_A10_multi_select$data[[cut_name]][["A10r6_row_6"]] <- list(
...
all_tables[["A10_multi_select"]] <- table_A10_multi_select
print(paste("Generated frequency table: A10_multi_select"))

# -----------------------------------------------------------------------------
# Table: b1_overall (mean_rows)
# Title: B1 - Percentage of patients covered by each type of insurance
# Rows: 8
# -----------------------------------------------------------------------------

table_b1_overall <- list(
  tableId = "b1_overall",
  title = "B1 - Percentage of patients covered by each type of insurance",
  tableType = "mean_rows",
  hints = c(),
...
for (cut_name in names(cuts)) {
  cut_data <- apply_cut(data, cuts[[cut_name]])
  table_b1_overall$data[[cut_name]] <- list()
  table_b1_overall$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_b1_overall$data[[cut_name]][["B1r1"]] <- list(
      label = "Not insured",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_b1_overall$data[[cut_name]][["B1r2"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_b1_overall$data[[cut_name]][["B1r3"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_b1_overall$data[[cut_name]][["B1r4"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_b1_overall$data[[cut_name]][["B1r5"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_b1_overall$data[[cut_name]][["B1r6"]] <- list(
      label = "Medicaid",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
  ...
  if (!is.null(var_col)) {
    ...
    table_b1_overall$data[[cut_name]][["B1r7"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_b1_overall$data[[cut_name]][["B1r8"]] <- list(
      label = "Other",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
...
all_tables[["b1_overall"]] <- table_b1_overall
print(paste("Generated mean_rows table: b1_overall"))

# -----------------------------------------------------------------------------
# Table: b3 (frequency)
# Title: B3 - Practice location
# Rows: 3
# -----------------------------------------------------------------------------
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_b4$data[[cut_name]][["B4"]] <- list(
      label = "How many physicians are in your practice? (Number; include yourself where applicable)",
      n = n,
      mean = mean_val,
      mean_label = "Mean (overall)",
      median = median_val,
...
# -----------------------------------------------------------------------------
# Table: b5_specialty (frequency)
# Title: B5 - Specialty/Training (select all that apply)
# Rows: 5
# -----------------------------------------------------------------------------

table_b5_specialty <- list(
  tableId = "b5_specialty",
  title = "B5 - Specialty/Training (select all that apply)",
  tableType = "frequency",
  hints = c(),
  isDerived = FALSE,
...
for (cut_name in names(cuts)) {
  cut_data <- apply_cut(data, cuts[[cut_name]])
  table_b5_specialty$data[[cut_name]] <- list()
  table_b5_specialty$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_b5_specialty$data[[cut_name]][["B5r1_row_1"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_b5_specialty$data[[cut_name]][["B5r2_row_2"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_b5_specialty$data[[cut_name]][["B5r3_row_3"]] <- list(
      label = "Primary Care",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_b5_specialty$data[[cut_name]][["B5r4_row_4"]] <- list(
  ...
  if (!is.null(var_col)) {
    ...
    table_b5_specialty$data[[cut_name]][["B5r5_row_5"]] <- list(
...
all_tables[["b5_specialty"]] <- table_b5_specialty
print(paste("Generated frequency table: b5_specialty"))

# -----------------------------------------------------------------------------
# Table: qCARD_SPECIALTY (frequency)
# Title: S2: Primary specialty/role (grouped)
# Rows: 2
# -----------------------------------------------------------------------------
...
# Title: qSPECIALTY - Primary specialty/role (S2)
# Rows: 3
# -----------------------------------------------------------------------------
...
# Title: TYPE OF CARD - Distribution
# Rows: 3
# -----------------------------------------------------------------------------
...
# Title: US_State - Distribution of responses by state
# Rows: 53
# -----------------------------------------------------------------------------
...
output <- list(
  metadata = list(
    generatedAt = "2026-01-08T21:37:55.888Z",
    tableCount = 54,
    cutCount = 21,
