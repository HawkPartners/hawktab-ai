...
/**
 * Format the full datamap as context for the agent.
 *
 ...
 */
function formatFullDatamapContext(verboseDataMap: VerboseDataMapType[]): string {
 ...
 */
function extractVariablesFromFilter(filterExpr: string): string[] {
...
/**
 * Validate that all variables in additionalFilter exist in the datamap.
