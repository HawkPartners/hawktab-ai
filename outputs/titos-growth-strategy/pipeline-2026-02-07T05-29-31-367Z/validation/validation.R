...
# Generated: 2026-02-07T05:50:48.072Z
# Tables to validate: 72
...
validation_results[["s6a"]] <- tryCatch({
  ...
  # Row 1: NET - Any family origin listed (NET)
...
# -----------------------------------------------------------------------------
# Table: s8_bins (frequency)
# -----------------------------------------------------------------------------

validation_results[["s8_bins"]] <- tryCatch({
  ...
  # Row 4: S8 == 7-12
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) >= 7 & as.numeric(data[["S8"]]) <= 12, na.rm = TRUE)
  # Row 5: S8 == 13-50
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) >= 13 & as.numeric(data[["S8"]]) <= 50, na.rm = TRUE)
  # Row 6: S8 == 1-50
  if (!("S8" %in% names(data))) stop("Variable 'S8' not found")
  test_val <- sum(as.numeric(data[["S8"]]) >= 1 & as.numeric(data[["S8"]]) <= 50, na.rm = TRUE)

  list(success = TRUE, tableId = "s8_bins", rowCount = 6)

}, error = function(e) {
  list(success = FALSE, tableId = "s8_bins", error = conditionMessage(e))
})

print(paste("Validated:", "s8_bins", "-", if(validation_results[["s8_bins"]]$success) "PASS" else paste("FAIL:", validation_results[["s8_bins"]]$error)))
...
validation_results[["s9"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s9", rowCount = 17)
...
# -----------------------------------------------------------------------------
# Table: s10b_s10a_1_subcategory (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_s10a_1_subcategory"]] <- tryCatch({

  # Row 1: Category header - More specifically, what best describes that moment? (skip validation)
  # Row 2: S10b == 1
  ...
  list(success = TRUE, tableId = "s10b_s10a_1_subcategory", rowCount = 38)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_s10a_1_subcategory", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_s10a_1_subcategory", "-", if(validation_results[["s10b_s10a_1_subcategory"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_s10a_1_subcategory"]]$error)))

# -----------------------------------------------------------------------------
# Table: s10b_s10a_2_subcategory (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_s10a_2_subcategory"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s10b_s10a_2_subcategory", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_s10a_2_subcategory", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_s10a_2_subcategory", "-", if(validation_results[["s10b_s10a_2_subcategory"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_s10a_2_subcategory"]]$error)))

# -----------------------------------------------------------------------------
# Table: s10b_s10a_3_subcategory (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_s10a_3_subcategory"]] <- tryCatch({

  # Row 1: Category header - More specifically, what best describes that moment? (shown based on previous answer) (skip validation)
  # Row 2: S10b == 1
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 1, na.rm = TRUE)
  # Row 3: S10b == 2
  ...
  list(success = TRUE, tableId = "s10b_s10a_3_subcategory", rowCount = 38)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_s10a_3_subcategory", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_s10a_3_subcategory", "-", if(validation_results[["s10b_s10a_3_subcategory"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_s10a_3_subcategory"]]$error)))

# -----------------------------------------------------------------------------
# Table: s10b_s10a_4_subcategory (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_s10a_4_subcategory"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s10b_s10a_4_subcategory", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_s10a_4_subcategory", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_s10a_4_subcategory", "-", if(validation_results[["s10b_s10a_4_subcategory"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_s10a_4_subcategory"]]$error)))

# -----------------------------------------------------------------------------
# Table: s10b_s10a_5_subcategory (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_s10a_5_subcategory"]] <- tryCatch({

  # Row 1: Category header - More specifically, which best describes that moment: (skip validation)
  # Row 2: S10b == 1
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 1, na.rm = TRUE)
  # Row 3: S10b == 2
  ...
  list(success = TRUE, tableId = "s10b_s10a_5_subcategory", rowCount = 38)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_s10a_5_subcategory", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_s10a_5_subcategory", "-", if(validation_results[["s10b_s10a_5_subcategory"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_s10a_5_subcategory"]]$error)))

# -----------------------------------------------------------------------------
# Table: s10b_s10a_6_subcategory (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_s10a_6_subcategory"]] <- tryCatch({

  # Row 1: Category header - Follow-up to: "A way to demonstrate that you have good taste" (skip validation)
  # Row 2: S10b == 6
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 6, na.rm = TRUE)
  # Row 3: S10b == 7
  ...
  list(success = TRUE, tableId = "s10b_s10a_6_subcategory", rowCount = 13)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_s10a_6_subcategory", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_s10a_6_subcategory", "-", if(validation_results[["s10b_s10a_6_subcategory"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_s10a_6_subcategory"]]$error)))

# -----------------------------------------------------------------------------
# Table: s10b_s10a_7_subcategory (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_s10a_7_subcategory"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s10b_s10a_7_subcategory", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_s10a_7_subcategory", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_s10a_7_subcategory", "-", if(validation_results[["s10b_s10a_7_subcategory"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_s10a_7_subcategory"]]$error)))

# -----------------------------------------------------------------------------
# Table: s10b_s10a_8_subcategory (frequency)
# -----------------------------------------------------------------------------

validation_results[["s10b_s10a_8_subcategory"]] <- tryCatch({
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 13, na.rm = TRUE)
  # Row 15: Category header - Transport / Escape (skip validation)
  # Row 16: S10b == 14
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 14, na.rm = TRUE)
  # Row 17: Category header - Celebration (skip validation)
  # Row 18: S10b == 16
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 16, na.rm = TRUE)
  # Row 19: S10b == 17
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 19, na.rm = TRUE)
  # Row 21: Category header - Indulgence / Personal Treat (skip validation)
  # Row 22: S10b == 21
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 21, na.rm = TRUE)
  # Row 23: S10b == 24
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 24, na.rm = TRUE)
  # Row 24: Category header - Escape / Relaxation (skip validation)
  # Row 25: S10b == 26
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 26, na.rm = TRUE)
  # Row 26: S10b == 27
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 29, na.rm = TRUE)
  # Row 29: Category header - Performance / Social Ready (skip validation)
  # Row 30: S10b == 31
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 31, na.rm = TRUE)
  # Row 31: S10b == 32
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 34, na.rm = TRUE)
  # Row 33: Category header - Tradition / Family (skip validation)
  # Row 34: S10b == 36
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 36, na.rm = TRUE)
  # Row 35: S10b == 37
  ...
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 39, na.rm = TRUE)
  # Row 38: Category header - Treat / Personal Reward (skip validation)
  # Row 39: S10b == 40
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 40, na.rm = TRUE)
  # Row 40: Category header - Other (open text) — interviewer-anchored options (skip validation)
  # Row 41: S10b == 100
  if (!("S10b" %in% names(data))) stop("Variable 'S10b' not found")
  test_val <- sum(as.numeric(data[["S10b"]]) == 100, na.rm = TRUE)
  # Row 42: S10b == 101
  ...
  list(success = TRUE, tableId = "s10b_s10a_8_subcategory", rowCount = 48)

}, error = function(e) {
  list(success = FALSE, tableId = "s10b_s10a_8_subcategory", error = conditionMessage(e))
})

print(paste("Validated:", "s10b_s10a_8_subcategory", "-", if(validation_results[["s10b_s10a_8_subcategory"]]$success) "PASS" else paste("FAIL:", validation_results[["s10b_s10a_8_subcategory"]]$error)))
...
# -----------------------------------------------------------------------------
# Table: s11b_s11a_1 (frequency)
# -----------------------------------------------------------------------------

validation_results[["s11b_s11a_1"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s11b_s11a_1", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s11b_s11a_1", error = conditionMessage(e))
})

print(paste("Validated:", "s11b_s11a_1", "-", if(validation_results[["s11b_s11a_1"]]$success) "PASS" else paste("FAIL:", validation_results[["s11b_s11a_1"]]$error)))

# -----------------------------------------------------------------------------
# Table: s11b_s11a_2 (frequency)
# -----------------------------------------------------------------------------

validation_results[["s11b_s11a_2"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s11b_s11a_2", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s11b_s11a_2", error = conditionMessage(e))
})

print(paste("Validated:", "s11b_s11a_2", "-", if(validation_results[["s11b_s11a_2"]]$success) "PASS" else paste("FAIL:", validation_results[["s11b_s11a_2"]]$error)))

# -----------------------------------------------------------------------------
# Table: s11b_s11a_3 (frequency)
# -----------------------------------------------------------------------------

validation_results[["s11b_s11a_3"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s11b_s11a_3", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s11b_s11a_3", error = conditionMessage(e))
})

print(paste("Validated:", "s11b_s11a_3", "-", if(validation_results[["s11b_s11a_3"]]$success) "PASS" else paste("FAIL:", validation_results[["s11b_s11a_3"]]$error)))

# -----------------------------------------------------------------------------
# Table: s11b_s11a_4 (frequency)
# -----------------------------------------------------------------------------

validation_results[["s11b_s11a_4"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s11b_s11a_4", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s11b_s11a_4", error = conditionMessage(e))
})

print(paste("Validated:", "s11b_s11a_4", "-", if(validation_results[["s11b_s11a_4"]]$success) "PASS" else paste("FAIL:", validation_results[["s11b_s11a_4"]]$error)))

# -----------------------------------------------------------------------------
# Table: s11b_s11a_5 (frequency)
# -----------------------------------------------------------------------------

validation_results[["s11b_s11a_5"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s11b_s11a_5", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s11b_s11a_5", error = conditionMessage(e))
})

print(paste("Validated:", "s11b_s11a_5", "-", if(validation_results[["s11b_s11a_5"]]$success) "PASS" else paste("FAIL:", validation_results[["s11b_s11a_5"]]$error)))

# -----------------------------------------------------------------------------
# Table: s11b_s11a_6 (frequency)
# -----------------------------------------------------------------------------

validation_results[["s11b_s11a_6"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s11b_s11a_6", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s11b_s11a_6", error = conditionMessage(e))
})

print(paste("Validated:", "s11b_s11a_6", "-", if(validation_results[["s11b_s11a_6"]]$success) "PASS" else paste("FAIL:", validation_results[["s11b_s11a_6"]]$error)))

# -----------------------------------------------------------------------------
# Table: s11b_s11a_7 (frequency)
# -----------------------------------------------------------------------------

validation_results[["s11b_s11a_7"]] <- tryCatch({

  # Row 1: Category header - Moment descriptions: (skip validation)
  # Row 2: S11b == 1
  if (!("S11b" %in% names(data))) stop("Variable 'S11b' not found")
  test_val <- sum(as.numeric(data[["S11b"]]) == 1, na.rm = TRUE)
  # Row 3: S11b == 2
  ...
  list(success = TRUE, tableId = "s11b_s11a_7", rowCount = 38)

}, error = function(e) {
  list(success = FALSE, tableId = "s11b_s11a_7", error = conditionMessage(e))
})

print(paste("Validated:", "s11b_s11a_7", "-", if(validation_results[["s11b_s11a_7"]]$success) "PASS" else paste("FAIL:", validation_results[["s11b_s11a_7"]]$error)))

# -----------------------------------------------------------------------------
# Table: s11b_s11a_8 (frequency)
# -----------------------------------------------------------------------------

validation_results[["s11b_s11a_8"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "s11b_s11a_8", rowCount = 37)

}, error = function(e) {
  list(success = FALSE, tableId = "s11b_s11a_8", error = conditionMessage(e))
})

print(paste("Validated:", "s11b_s11a_8", "-", if(validation_results[["s11b_s11a_8"]]$success) "PASS" else paste("FAIL:", validation_results[["s11b_s11a_8"]]$error)))
...
validation_results[["a4"]] <- tryCatch({
  ...
  # Row 16: NET - Spirits (NET)
  if (!("A4" %in% names(data))) stop("NET component variable 'A4' not found")
  if (!("A4" %in% names(data))) stop("NET component variable 'A4' not found")
  if (!("A4" %in% names(data))) stop("NET component variable 'A4' not found")
  if (!("A4" %in% names(data))) stop("NET component variable 'A4' not found")
  if (!("A4" %in% names(data))) stop("NET component variable 'A4' not found")
...
validation_results[["a6"]] <- tryCatch({
  ...
  # Row 1: A6 == 1
  if (!("A6" %in% names(data))) stop("Variable 'A6' not found")
  test_val <- sum(as.numeric(data[["A6"]]) == 1, na.rm = TRUE)
  # Row 2: A6 == 2
  if (!("A6" %in% names(data))) stop("Variable 'A6' not found")
  test_val <- sum(as.numeric(data[["A6"]]) == 2, na.rm = TRUE)
  # Row 3: A6 == 3
  if (!("A6" %in% names(data))) stop("Variable 'A6' not found")
  test_val <- sum(as.numeric(data[["A6"]]) == 3, na.rm = TRUE)
  # Row 4: A6 == 4
  if (!("A6" %in% names(data))) stop("Variable 'A6' not found")
  test_val <- sum(as.numeric(data[["A6"]]) == 4, na.rm = TRUE)
  # Row 5: A6 == 5
  if (!("A6" %in% names(data))) stop("Variable 'A6' not found")
  test_val <- sum(as.numeric(data[["A6"]]) == 5, na.rm = TRUE)
...
validation_results[["a10_bins"]] <- tryCatch({
  ...
  # Row 1: A10 == 1
  if (!("A10" %in% names(data))) stop("Variable 'A10' not found")
  test_val <- sum(as.numeric(data[["A10"]]) == 1, na.rm = TRUE)
  # Row 2: A10 == 2
  if (!("A10" %in% names(data))) stop("Variable 'A10' not found")
  ...
  # Row 4: A10 == 5-8
  if (!("A10" %in% names(data))) stop("Variable 'A10' not found")
  test_val <- sum(as.numeric(data[["A10"]]) >= 5 & as.numeric(data[["A10"]]) <= 8, na.rm = TRUE)
  # Row 5: A10 == 9-30
  if (!("A10" %in% names(data))) stop("Variable 'A10' not found")
  test_val <- sum(as.numeric(data[["A10"]]) >= 9 & as.numeric(data[["A10"]]) <= 30, na.rm = TRUE)

  list(success = TRUE, tableId = "a10_bins", rowCount = 5)
...
validation_results[["a11"]] <- tryCatch({
  ...
  # Row 1: A11 == 4,5
  if (!("A11" %in% names(data))) stop("Variable 'A11' not found")
  test_val <- sum(as.numeric(data[["A11"]]) %in% c(4, 5), na.rm = TRUE)
  # Row 2: A11 == 5
  if (!("A11" %in% names(data))) stop("Variable 'A11' not found")
  test_val <- sum(as.numeric(data[["A11"]]) == 5, na.rm = TRUE)
  # Row 3: A11 == 4
  if (!("A11" %in% names(data))) stop("Variable 'A11' not found")
  test_val <- sum(as.numeric(data[["A11"]]) == 4, na.rm = TRUE)
  # Row 4: A11 == 3
  if (!("A11" %in% names(data))) stop("Variable 'A11' not found")
  test_val <- sum(as.numeric(data[["A11"]]) == 3, na.rm = TRUE)
  # Row 5: A11 == 1,2
  if (!("A11" %in% names(data))) stop("Variable 'A11' not found")
  test_val <- sum(as.numeric(data[["A11"]]) %in% c(1, 2), na.rm = TRUE)
  # Row 6: A11 == 2
  if (!("A11" %in% names(data))) stop("Variable 'A11' not found")
  test_val <- sum(as.numeric(data[["A11"]]) == 2, na.rm = TRUE)
  # Row 7: A11 == 1
  if (!("A11" %in% names(data))) stop("Variable 'A11' not found")
  test_val <- sum(as.numeric(data[["A11"]]) == 1, na.rm = TRUE)
...
# -----------------------------------------------------------------------------
# Table: a22_casamigos (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_casamigos"]] <- tryCatch({
  ...
  # Row 2: A22r1c5 == 0
  if (!("A22r1c5" %in% names(data))) stop("Variable 'A22r1c5' not found")
  test_val <- sum(as.numeric(data[["A22r1c5"]]) == 0, na.rm = TRUE)

  list(success = TRUE, tableId = "a22_casamigos", rowCount = 2)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_casamigos", error = conditionMessage(e))
})

print(paste("Validated:", "a22_casamigos", "-", if(validation_results[["a22_casamigos"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_casamigos"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_don_julio (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_don_julio"]] <- tryCatch({

  # Row 1: A22r1c6 == 1
  if (!("A22r1c6" %in% names(data))) stop("Variable 'A22r1c6' not found")
  test_val <- sum(as.numeric(data[["A22r1c6"]]) == 1, na.rm = TRUE)

  list(success = TRUE, tableId = "a22_don_julio", rowCount = 1)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_don_julio", error = conditionMessage(e))
})

print(paste("Validated:", "a22_don_julio", "-", if(validation_results[["a22_don_julio"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_don_julio"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_grey_goose (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_grey_goose"]] <- tryCatch({

  # Row 1: A22r1c2 == 1
  if (!("A22r1c2" %in% names(data))) stop("Variable 'A22r1c2' not found")
  test_val <- sum(as.numeric(data[["A22r1c2"]]) == 1, na.rm = TRUE)

  list(success = TRUE, tableId = "a22_grey_goose", rowCount = 1)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_grey_goose", error = conditionMessage(e))
})

print(paste("Validated:", "a22_grey_goose", "-", if(validation_results[["a22_grey_goose"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_grey_goose"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_ketel_one (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_ketel_one"]] <- tryCatch({
  ...
  # Row 2: A22r1c3 == 0
  if (!("A22r1c3" %in% names(data))) stop("Variable 'A22r1c3' not found")
  test_val <- sum(as.numeric(data[["A22r1c3"]]) == 0, na.rm = TRUE)

  list(success = TRUE, tableId = "a22_ketel_one", rowCount = 2)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_ketel_one", error = conditionMessage(e))
})

print(paste("Validated:", "a22_ketel_one", "-", if(validation_results[["a22_ketel_one"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_ketel_one"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_maker_s_mark (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_maker_s_mark"]] <- tryCatch({
  ...
  # Row 2: A22r1c4 == 0
  if (!("A22r1c4" %in% names(data))) stop("Variable 'A22r1c4' not found")
  test_val <- sum(as.numeric(data[["A22r1c4"]]) == 0, na.rm = TRUE)

  list(success = TRUE, tableId = "a22_maker_s_mark", rowCount = 2)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_maker_s_mark", error = conditionMessage(e))
})

print(paste("Validated:", "a22_maker_s_mark", "-", if(validation_results[["a22_maker_s_mark"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_maker_s_mark"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_none_of_the_above (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_none_of_the_above"]] <- tryCatch({

  # Row 1: A22r1c7 == 1
  if (!("A22r1c7" %in% names(data))) stop("Variable 'A22r1c7' not found")
  test_val <- sum(as.numeric(data[["A22r1c7"]]) == 1, na.rm = TRUE)

  list(success = TRUE, tableId = "a22_none_of_the_above", rowCount = 1)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_none_of_the_above", error = conditionMessage(e))
})

print(paste("Validated:", "a22_none_of_the_above", "-", if(validation_results[["a22_none_of_the_above"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_none_of_the_above"]]$error)))

# -----------------------------------------------------------------------------
# Table: a22_tito_s_handmade_vodka (frequency)
# -----------------------------------------------------------------------------

validation_results[["a22_tito_s_handmade_vodka"]] <- tryCatch({

  # Row 1: A22r1c1 == 1
  if (!("A22r1c1" %in% names(data))) stop("Variable 'A22r1c1' not found")
  test_val <- sum(as.numeric(data[["A22r1c1"]]) == 1, na.rm = TRUE)

  list(success = TRUE, tableId = "a22_tito_s_handmade_vodka", rowCount = 1)

}, error = function(e) {
  list(success = FALSE, tableId = "a22_tito_s_handmade_vodka", error = conditionMessage(e))
})

print(paste("Validated:", "a22_tito_s_handmade_vodka", "-", if(validation_results[["a22_tito_s_handmade_vodka"]]$success) "PASS" else paste("FAIL:", validation_results[["a22_tito_s_handmade_vodka"]]$error)))
...
validation_results[["a23_grey_goose"]] <- tryCatch({
  ...
  list(success = TRUE, tableId = "a23_grey_goose", rowCount = 6)
...
validation_results[["a14b_1"]] <- tryCatch({
  ...
  # Row 14: NET - On-premise (NET)
  if (!("A14b_1" %in% names(data))) stop("NET component variable 'A14b_1' not found")
  if (!("A14b_1" %in% names(data))) stop("NET component variable 'A14b_1' not found")
  if (!("A14b_1" %in% names(data))) stop("NET component variable 'A14b_1' not found")
  if (!("A14b_1" %in% names(data))) stop("NET component variable 'A14b_1' not found")
  # Row 15: NET - Off-premise (NET)
  if (!("A14b_1" %in% names(data))) stop("NET component variable 'A14b_1' not found")
  if (!("A14b_1" %in% names(data))) stop("NET component variable 'A14b_1' not found")
  if (!("A14b_1" %in% names(data))) stop("NET component variable 'A14b_1' not found")
  if (!("A14b_1" %in% names(data))) stop("NET component variable 'A14b_1' not found")
...
validation_results[["a14b_2"]] <- tryCatch({
  ...
  # Row 1: A14b_2 == 1,2,3,4
  if (!("A14b_2" %in% names(data))) stop("Variable 'A14b_2' not found")
  test_val <- sum(as.numeric(data[["A14b_2"]]) %in% c(1, 2, 3, 4), na.rm = TRUE)
  # Row 2: A14b_2 == 1
  if (!("A14b_2" %in% names(data))) stop("Variable 'A14b_2' not found")
...
# -----------------------------------------------------------------------------
# Table: a17_1 (frequency)
# -----------------------------------------------------------------------------

validation_results[["a17_1"]] <- tryCatch({

  # Row 1: NET - Any reason (NET)
  if (!("A17r1" %in% names(data))) stop("NET component variable 'A17r1' not found")
  if (!("A17r2" %in% names(data))) stop("NET component variable 'A17r2' not found")
  if (!("A17r3" %in% names(data))) stop("NET component variable 'A17r3' not found")
  if (!("A17r4" %in% names(data))) stop("NET component variable 'A17r4' not found")
  if (!("A17r5" %in% names(data))) stop("NET component variable 'A17r5' not found")
  if (!("A17r6" %in% names(data))) stop("NET component variable 'A17r6' not found")
  if (!("A17r7" %in% names(data))) stop("NET component variable 'A17r7' not found")
  if (!("A17r8" %in% names(data))) stop("NET component variable 'A17r8' not found")
  if (!("A17r9" %in% names(data))) stop("NET component variable 'A17r9' not found")
  # Row 2: A17r1 == 1
  if (!("A17r1" %in% names(data))) stop("Variable 'A17r1' not found")
  test_val <- sum(as.numeric(data[["A17r1"]]) == 1, na.rm = TRUE)
  # Row 3: A17r2 == 1
  if (!("A17r2" %in% names(data))) stop("Variable 'A17r2' not found")
  test_val <- sum(as.numeric(data[["A17r2"]]) == 1, na.rm = TRUE)
  # Row 4: A17r3 == 1
  if (!("A17r3" %in% names(data))) stop("Variable 'A17r3' not found")
  test_val <- sum(as.numeric(data[["A17r3"]]) == 1, na.rm = TRUE)
  # Row 5: A17r4 == 1
  if (!("A17r4" %in% names(data))) stop("Variable 'A17r4' not found")
  test_val <- sum(as.numeric(data[["A17r4"]]) == 1, na.rm = TRUE)
  # Row 6: A17r5 == 1
  if (!("A17r5" %in% names(data))) stop("Variable 'A17r5' not found")
  test_val <- sum(as.numeric(data[["A17r5"]]) == 1, na.rm = TRUE)
  # Row 7: A17r6 == 1
  if (!("A17r6" %in% names(data))) stop("Variable 'A17r6' not found")
  test_val <- sum(as.numeric(data[["A17r6"]]) == 1, na.rm = TRUE)
  # Row 8: A17r7 == 1
  if (!("A17r7" %in% names(data))) stop("Variable 'A17r7' not found")
  test_val <- sum(as.numeric(data[["A17r7"]]) == 1, na.rm = TRUE)
  # Row 9: A17r8 == 1
  if (!("A17r8" %in% names(data))) stop("Variable 'A17r8' not found")
  test_val <- sum(as.numeric(data[["A17r8"]]) == 1, na.rm = TRUE)
  # Row 10: A17r9 == 1
  if (!("A17r9" %in% names(data))) stop("Variable 'A17r9' not found")
  test_val <- sum(as.numeric(data[["A17r9"]]) == 1, na.rm = TRUE)
...
# -----------------------------------------------------------------------------
# Table: a19_1 (frequency)
# -----------------------------------------------------------------------------

validation_results[["a19_1"]] <- tryCatch({

  # Row 1: NET - Any reason (NET)
  if (!("A19r1" %in% names(data))) stop("NET component variable 'A19r1' not found")
  if (!("A19r2" %in% names(data))) stop("NET component variable 'A19r2' not found")
  if (!("A19r3" %in% names(data))) stop("NET component variable 'A19r3' not found")
  if (!("A19r4" %in% names(data))) stop("NET component variable 'A19r4' not found")
  if (!("A19r5" %in% names(data))) stop("NET component variable 'A19r5' not found")
  if (!("A19r6" %in% names(data))) stop("NET component variable 'A19r6' not found")
  if (!("A19r7" %in% names(data))) stop("NET component variable 'A19r7' not found")
  if (!("A19r8" %in% names(data))) stop("NET component variable 'A19r8' not found")
  if (!("A19r9" %in% names(data))) stop("NET component variable 'A19r9' not found")
  if (!("A19r10" %in% names(data))) stop("NET component variable 'A19r10' not found")
  if (!("A19r11" %in% names(data))) stop("NET component variable 'A19r11' not found")
  # Row 2: A19r1 == 1
  if (!("A19r1" %in% names(data))) stop("Variable 'A19r1' not found")
  test_val <- sum(as.numeric(data[["A19r1"]]) == 1, na.rm = TRUE)
  # Row 3: A19r2 == 1
  if (!("A19r2" %in% names(data))) stop("Variable 'A19r2' not found")
  test_val <- sum(as.numeric(data[["A19r2"]]) == 1, na.rm = TRUE)
  # Row 4: A19r3 == 1
  if (!("A19r3" %in% names(data))) stop("Variable 'A19r3' not found")
  test_val <- sum(as.numeric(data[["A19r3"]]) == 1, na.rm = TRUE)
  # Row 5: A19r4 == 1
  if (!("A19r4" %in% names(data))) stop("Variable 'A19r4' not found")
  test_val <- sum(as.numeric(data[["A19r4"]]) == 1, na.rm = TRUE)
  # Row 6: A19r5 == 1
  if (!("A19r5" %in% names(data))) stop("Variable 'A19r5' not found")
  test_val <- sum(as.numeric(data[["A19r5"]]) == 1, na.rm = TRUE)
  # Row 7: A19r6 == 1
  if (!("A19r6" %in% names(data))) stop("Variable 'A19r6' not found")
  test_val <- sum(as.numeric(data[["A19r6"]]) == 1, na.rm = TRUE)
  # Row 8: A19r7 == 1
  if (!("A19r7" %in% names(data))) stop("Variable 'A19r7' not found")
  test_val <- sum(as.numeric(data[["A19r7"]]) == 1, na.rm = TRUE)
  # Row 9: A19r8 == 1
  if (!("A19r8" %in% names(data))) stop("Variable 'A19r8' not found")
  test_val <- sum(as.numeric(data[["A19r8"]]) == 1, na.rm = TRUE)
  # Row 10: A19r9 == 1
  if (!("A19r9" %in% names(data))) stop("Variable 'A19r9' not found")
  test_val <- sum(as.numeric(data[["A19r9"]]) == 1, na.rm = TRUE)
  # Row 11: A19r10 == 1
  if (!("A19r10" %in% names(data))) stop("Variable 'A19r10' not found")
  test_val <- sum(as.numeric(data[["A19r10"]]) == 1, na.rm = TRUE)
  # Row 12: A19r11 == 1
  if (!("A19r11" %in% names(data))) stop("Variable 'A19r11' not found")
  test_val <- sum(as.numeric(data[["A19r11"]]) == 1, na.rm = TRUE)
  # Row 13: A19r12 == 1
  if (!("A19r12" %in% names(data))) stop("Variable 'A19r12' not found")
  test_val <- sum(as.numeric(data[["A19r12"]]) == 1, na.rm = TRUE)
...
validation_results[["a7_1"]] <- tryCatch({
  ...
  # Row 7: A7r6 == 1
  if (!("A7r6" %in% names(data))) stop("Variable 'A7r6' not found")
  test_val <- sum(as.numeric(data[["A7r6"]]) == 1, na.rm = TRUE)
