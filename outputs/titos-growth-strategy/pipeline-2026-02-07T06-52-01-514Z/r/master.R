...
# Session: pipeline-2026-02-07T06-52-01-514Z
# Generated: 2026-02-07T07:05:05.355Z
...
table_s1 <- list(
  ...
  baseText = "",
  userNote = "(Select all that apply; note: selecting Advertising, Journalism, or Marketing was programmed to terminate the respondent)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
for (cut_name in names(cuts)) {
  ...
  # Row 1: NET - Any industry (NET) (components: S1r1, S1r2, S1r3, S1r4, S1r5, S1r6, S1r7)
  ...
  pct <- if (base_n > 0) round_half_up(count / base_n * 100) else 0
    ...
    table_s1$data[[cut_name]][["_NET_AnyIndustry_row_1"]] <- list(
      label = "Any industry (NET)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
...
table_s2 <- list(
  ...
  surveySection = "SCREENER",
  baseText = "",
  userNote = "(Respondents aged 21–74; numeric — summary statistics are auto-generated)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
table_s2_bins <- list(
  ...
  surveySection = "SCREENER",
  baseText = "",
  userNote = "(Binned distribution to complement mean/summary stats)",
  tableSubtitle = "Age distribution (bins)",
  excluded = FALSE,
  excludeReason = "",
  data = list()
)
...
for (cut_name in names(cuts)) {
  ...
  # Row 1: NET - Any of the listed countries/regions (NET) (components: S6ar1, S6ar2, S6ar3, S6ar4, S6ar5, S6ar6, S6ar7, S6ar8)
  ...
  pct <- if (base_n > 0) round_half_up(count / base_n * 100) else 0
    ...
    table_s6a$data[[cut_name]][["_NET_S6a_Any_row_1"]] <- list(
      label = "Any of the listed countries/regions (NET)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
...
# -----------------------------------------------------------------------------
# Table: s8 (mean_rows)
# Question: How many alcoholic drinks, if any, have you consumed in the past week? For example, if you had 3 beers and 2 different cocktails, that would be 5 alcoholic drinks. Please provide an honest, best-estimate — we are trying to reach a range of different
# Rows: 1
# Source: s8
# -----------------------------------------------------------------------------
...
table_s8 <- list(
  tableId = "s8",
  questionId = "S8",
  questionText = "How many alcoholic drinks, if any, have you consumed in the past week? For example, if you had 3 beers and 2 different cocktails, that would be 5 alcoholic drinks. Please provide an honest, best-estimate — we are trying to reach a range of different",
  tableType = "mean_rows",
  isDerived = FALSE,
  sourceTableId = "s8",
  surveySection = "SCREENER",
  baseText = "Respondents who consumed alcohol in the past week",
  userNote = "(Entered as a whole number; respondents reporting 0 drinks were terminated)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
table_s8_binned <- list(
  ...
  surveySection = "SCREENER",
  baseText = "Respondents who consumed alcohol in the past week",
  userNote = "(Binned view of S8; entered as whole numbers. The survey terminated respondents who entered 0.)",
...
for (cut_name in names(cuts)) {
  ...
  # Row 4: S8 in range [7-14]
  var_col <- safe_get_var(cut_data, "S8")
  if (!is.null(var_col)) {
    base_n <- sum(!is.na(var_col))
    count <- sum(as.numeric(var_col) >= 7 & as.numeric(var_col) <= 14, na.rm = TRUE)
    pct <- if (base_n > 0) round_half_up(count / base_n * 100) else 0
  ...
  # Row 5: S8 in range [15-50]
  var_col <- safe_get_var(cut_data, "S8")
  if (!is.null(var_col)) {
    base_n <- sum(!is.na(var_col))
    count <- sum(as.numeric(var_col) >= 15 & as.numeric(var_col) <= 50, na.rm = TRUE)
    pct <- if (base_n > 0) round_half_up(count / base_n * 100) else 0

    table_s8_binned$data[[cut_name]][["S8_row_5"]] <- list(
      label = "15 or more drinks",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
# Question: Of the drinks you had in the past week, how many were consumed at each of the following locations? (Enter whole numbers; counts across locations should sum to your total number of drinks.)
# Rows: 19
# Source: s9
# -----------------------------------------------------------------------------
...
table_s9 <- list(
  tableId = "s9",
  questionId = "S9",
  questionText = "Of the drinks you had in the past week, how many were consumed at each of the following locations? (Enter whole numbers; counts across locations should sum to your total number of drinks.)",
  tableType = "mean_rows",
  isDerived = TRUE,
  sourceTableId = "s9",
  surveySection = "SCREENER",
  baseText = "Respondents who had at least one alcoholic drink in the past week.",
  userNote = "(Enter whole numbers; the counts across locations should sum to your total number of drinks reported.)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
# -----------------------------------------------------------------------------
# Table: s10b (frequency) [LOOP: Location 1 / Location 2]
...
table_s10b <- list(
  ...
  baseText = "About the specific drink occasion (Location 1 or 2)",
  userNote = "(Select one; subcategories shown based on the reason selected in the prior question)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
for (cut_name in names(cuts_Location 1 / Location 2)) {
  cut_data <- apply_cut(Location 1 / Location 2, cuts_Location 1 / Location 2[[cut_name]])
  ...
  # Row 20: Category header - Indulgence / Personal Treat
  table_s10b$data[[cut_name]][["_CAT__row_20"]] <- list(
    label = "Indulgence / Personal Treat",
    n = NA,
    count = NA,
    pct = NA,
    isNet = FALSE,
  ...
  # Row 29: Category header - Performance / Social Confidence
  table_s10b$data[[cut_name]][["_CAT__row_29"]] <- list(
    label = "Performance / Social Confidence",
    n = NA,
    count = NA,
    pct = NA,
    isNet = FALSE,
  ...
  # Row 38: Category header - Other (Specify)
...
table_s10c <- list(
  ...
  sourceTableId = "s10c",
  surveySection = "OCCASION LOOP",
  baseText = "Asked for each occasion/location in the loop (e.g., Location 1 or Location 2)",
  userNote = "(Select one)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
table_s11b <- list(
  ...
  sourceTableId = "",
  surveySection = "OCCASION LOOP",
  baseText = "Respondents in the occasion loop (asked about a specific recent drink/location)",
  userNote = "(Select one)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
for (cut_name in names(cuts)) {
  ...
  # Row 1: Category header - Connection / Belonging
  table_s11b$data[[cut_name]][["_CAT__row_1"]] <- list(
    label = "Connection / Belonging",
    n = NA,
    count = NA,
    pct = NA,
  ...
  # Row 6: Category header - Status / Image
  table_s11b$data[[cut_name]][["_CAT__row_6"]] <- list(
    label = "Status / Image",
    n = NA,
    count = NA,
    pct = NA,
  ...
  # Row 11: Category header - Exploration / Discovery
  table_s11b$data[[cut_name]][["_CAT__row_11"]] <- list(
    label = "Exploration / Discovery",
    n = NA,
    count = NA,
    pct = NA,
  ...
  # Row 16: Category header - Celebration
  table_s11b$data[[cut_name]][["_CAT__row_16"]] <- list(
    label = "Celebration",
    n = NA,
    count = NA,
    pct = NA,
  ...
  # Row 20: Category header - Indulgence / Personal Treat
  table_s11b$data[[cut_name]][["_CAT__row_20"]] <- list(
    label = "Indulgence / Personal Treat",
    n = NA,
    count = NA,
    pct = NA,
  ...
  if (!is.null(var_col)) {
    ...
    table_s11b$data[[cut_name]][["S11b_row_22"]] <- list(
      label = "A drink that feels rich / over-the-top (indulgent)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  # Row 23: Category header - Escape / Relief / Mindset
  table_s11b$data[[cut_name]][["_CAT__row_23"]] <- list(
    label = "Escape / Relief / Mindset",
    n = NA,
    count = NA,
    pct = NA,
    isNet = FALSE,
  ...
  # Row 28: Category header - Performance / Social Confidence
  table_s11b$data[[cut_name]][["_CAT__row_28"]] <- list(
    label = "Performance / Social Confidence",
    n = NA,
    count = NA,
    pct = NA,
  ...
  # Row 32: Category header - Tradition / Family
  table_s11b$data[[cut_name]][["_CAT__row_32"]] <- list(
    label = "Tradition / Family",
    n = NA,
    count = NA,
    pct = NA,
    isNet = FALSE,
  ...
  # Row 38: Category header - Other (Specify)
  table_s11b$data[[cut_name]][["_CAT__row_38"]] <- list(
    label = "Other (Specify)",
    n = NA,
    count = NA,
    pct = NA,
...
table_s11c <- list(
  ...
  sourceTableId = "s11c",
  surveySection = "OCCASION LOOP",
  baseText = "About the drink at Location 2 (occasion loop)",
  userNote = "(Select one)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
# Question: What time of day did you have this drink? As a reminder, we’re asking about the drink [INSERT LOCATION 1/LOCATION 2].
# Rows: 9
# Source: a2
# -----------------------------------------------------------------------------
...
table_a2 <- list(
  tableId = "a2",
  questionId = "A2",
  questionText = "What time of day did you have this drink? As a reminder, we’re asking about the drink [INSERT LOCATION 1/LOCATION 2].",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a2",
  surveySection = "OCCASION LOOP",
  baseText = "",
  userNote = "(Asked for each occasion/loop; select one)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
# Question: Which day of the week was this drink? (As a reminder, we’re asking about the drink at the selected location.)
# Rows: 9
# Source: a3
# -----------------------------------------------------------------------------
...
table_a3 <- list(
  tableId = "a3",
  questionId = "A3",
  questionText = "Which day of the week was this drink? (As a reminder, we’re asking about the drink at the selected location.)",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a3",
  surveySection = "OCCASION LOOP",
  baseText = "",
  userNote = "(Asked for each occasion: think about the drink at the selected location)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
for (cut_name in names(cuts_stacked_loop_1)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a4$data[[cut_name]][["A4_row_4"]] <- list(
      label = "Ready-to-Drink Cocktail (RTD) (e.g., High Noon, Cutwater)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  # Row 16: A4 IN (7, 8, 9, 10, 11, 12, 13, 14)
  var_col <- safe_get_var(cut_data, "A4")
  if (!is.null(var_col)) {
    base_n <- sum(!is.na(var_col))
...
table_a5 <- list(
  ...
  userNote = "(Asked when A4 indicated a spirits/liquor type)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
# Question: Which of the following reflect why you drank this drink?
# Rows: 5
# Source: a6
# -----------------------------------------------------------------------------
...
table_a6 <- list(
  tableId = "a6",
  questionId = "A6",
  questionText = "Which of the following reflect why you drank this drink?",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a6",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts_stacked_loop_1)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a6$data[[cut_name]][["A6_row_4"]] <- list(
      label = "The bartender or waiter recommended I try this drink",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
# Question: Was this drink planned or unplanned? (As a reminder, we’re asking about the drink at the specified location.)
# Rows: 4
# Source: a8
# -----------------------------------------------------------------------------
...
table_a8 <- list(
  tableId = "a8",
  questionId = "A8",
  questionText = "Was this drink planned or unplanned? (As a reminder, we’re asking about the drink at the specified location.)",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a8",
  surveySection = "OCCASION LOOP",
  baseText = "Asked about the specific drink at the location the respondent reported (looped question).",
  userNote = "(Select one)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
table_a10_dist_bins <- list(
  ...
  surveySection = "OCCASION LOOP",
  baseText = "Those who did NOT select \"I was alone\" on A9 (i.e., not alone)",
  userNote = "(Derived distribution: binned ranges; valid answers 2–30)",
  tableSubtitle = "Number of people: distribution (binned)",
  excluded = FALSE,
  excludeReason = "",
  data = list()
)
...
for (cut_name in names(cuts_stacked_loop_1)) {
  ...
  # Row 1: Category header - Number of people (binned)
  table_a10_dist_bins$data[[cut_name]][["_CAT__row_1"]] <- list(
    label = "Number of people (binned)",
    n = NA,
    count = NA,
    pct = NA,
    isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_a10_dist_bins$data[[cut_name]][["A10_row_6"]] <- list(
...
# Question: How satisfied were you with the drink you chose? (As a reminder, we’re asking about the drink at the occasion/location you selected.)
# Rows: 7
# Source: a11
# -----------------------------------------------------------------------------
...
table_a11 <- list(
  tableId = "a11",
  questionId = "A11",
  questionText = "How satisfied were you with the drink you chose? (As a reminder, we’re asking about the drink at the occasion/location you selected.)",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a11",
  surveySection = "OCCASION LOOP",
  baseText = "",
  userNote = "(5-point satisfaction scale; asked for the drink at the selected occasion/location)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
# Question: What brand of the drink did you have? (as asked for the drink specified earlier)
# Rows: 73
# Source: a13
# -----------------------------------------------------------------------------
...
table_a13 <- list(
  tableId = "a13",
  questionId = "A13",
  questionText = "What brand of the drink did you have? (as asked for the drink specified earlier)",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a13",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts_stacked_loop_1)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a13$data[[cut_name]][["A13_row_44"]] <- list(
      label = "New Amsterdam (duplicate list entry)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_a13$data[[cut_name]][["A13_row_51"]] <- list(
      label = "Fireball (duplicate list entry)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a20$data[[cut_name]][["A20_row_1"]] <- list(
      label = "More than usual (Top 2 Box, T2B)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
  ...
  if (!is.null(var_col)) {
    ...
    table_a20$data[[cut_name]][["A20_row_5"]] <- list(
      label = "Less than usual (Bottom 2 Box, B2B)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
...
for (cut_name in names(cuts)) {
  ...
  # Row 1: NET - Any of the listed brands (NET) (components: A21r1, A21r2, A21r3, A21r4, A21r5, A21r6)
  ...
  pct <- if (base_n > 0) round_half_up(count / base_n * 100) else 0
    ...
    table_a21$data[[cut_name]][["_NET_AnyBrand_row_1"]] <- list(
      label = "Any of the listed brands (NET)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
...
# -----------------------------------------------------------------------------
# Table: a22_attr_approachable (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Approachable?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_approachable <- list(
  tableId = "a22_attr_approachable",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Approachable?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_approachable$data[[cut_name]] <- list()
  table_a22_attr_approachable$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_approachable$data[[cut_name]][["A22r2c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_approachable$data[[cut_name]][["A22r2c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_approachable$data[[cut_name]][["A22r2c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_approachable$data[[cut_name]][["A22r2c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_approachable$data[[cut_name]][["A22r2c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_approachable$data[[cut_name]][["A22r2c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_approachable$data[[cut_name]][["A22r2c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_approachable"]] <- table_a22_attr_approachable
print(paste("Generated frequency table: a22_attr_approachable"))

# -----------------------------------------------------------------------------
# Table: a22_attr_authentic (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Authentic?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_authentic <- list(
  tableId = "a22_attr_authentic",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Authentic?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_authentic$data[[cut_name]] <- list()
  table_a22_attr_authentic$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_authentic$data[[cut_name]][["A22r3c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_authentic$data[[cut_name]][["A22r3c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_authentic$data[[cut_name]][["A22r3c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_authentic$data[[cut_name]][["A22r3c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_authentic$data[[cut_name]][["A22r3c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_authentic$data[[cut_name]][["A22r3c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_authentic$data[[cut_name]][["A22r3c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_authentic"]] <- table_a22_attr_authentic
print(paste("Generated frequency table: a22_attr_authentic"))

# -----------------------------------------------------------------------------
# Table: a22_attr_bold (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Bold?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_bold <- list(
  tableId = "a22_attr_bold",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Bold?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_bold$data[[cut_name]] <- list()
  table_a22_attr_bold$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_bold$data[[cut_name]][["A22r7c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_bold$data[[cut_name]][["A22r7c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_bold$data[[cut_name]][["A22r7c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_bold$data[[cut_name]][["A22r7c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_bold$data[[cut_name]][["A22r7c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_bold$data[[cut_name]][["A22r7c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_bold$data[[cut_name]][["A22r7c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_bold"]] <- table_a22_attr_bold
print(paste("Generated frequency table: a22_attr_bold"))

# -----------------------------------------------------------------------------
# Table: a22_attr_down_to_earth (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Down-to-Earth?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_down_to_earth <- list(
  tableId = "a22_attr_down_to_earth",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Down-to-Earth?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_down_to_earth$data[[cut_name]] <- list()
  table_a22_attr_down_to_earth$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_down_to_earth$data[[cut_name]][["A22r9c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_down_to_earth$data[[cut_name]][["A22r9c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_down_to_earth$data[[cut_name]][["A22r9c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_down_to_earth$data[[cut_name]][["A22r9c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_down_to_earth$data[[cut_name]][["A22r9c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_down_to_earth$data[[cut_name]][["A22r9c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_down_to_earth$data[[cut_name]][["A22r9c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_down_to_earth"]] <- table_a22_attr_down_to_earth
print(paste("Generated frequency table: a22_attr_down_to_earth"))

# -----------------------------------------------------------------------------
# Table: a22_attr_edgy (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Edgy?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_edgy <- list(
  tableId = "a22_attr_edgy",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Edgy?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_edgy$data[[cut_name]] <- list()
  table_a22_attr_edgy$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_edgy$data[[cut_name]][["A22r5c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_edgy$data[[cut_name]][["A22r5c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_edgy$data[[cut_name]][["A22r5c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_edgy$data[[cut_name]][["A22r5c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_edgy$data[[cut_name]][["A22r5c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_edgy$data[[cut_name]][["A22r5c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_edgy$data[[cut_name]][["A22r5c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_edgy"]] <- table_a22_attr_edgy
print(paste("Generated frequency table: a22_attr_edgy"))

# -----------------------------------------------------------------------------
# Table: a22_attr_generous (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Generous?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_generous <- list(
  tableId = "a22_attr_generous",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Generous?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_generous$data[[cut_name]] <- list()
  table_a22_attr_generous$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_generous$data[[cut_name]][["A22r4c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_generous$data[[cut_name]][["A22r4c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_generous$data[[cut_name]][["A22r4c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_generous$data[[cut_name]][["A22r4c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_generous$data[[cut_name]][["A22r4c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_generous$data[[cut_name]][["A22r4c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_generous$data[[cut_name]][["A22r4c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_generous"]] <- table_a22_attr_generous
print(paste("Generated frequency table: a22_attr_generous"))

# -----------------------------------------------------------------------------
# Table: a22_attr_independent (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Independent?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_independent <- list(
  tableId = "a22_attr_independent",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Independent?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_independent$data[[cut_name]] <- list()
  table_a22_attr_independent$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_independent$data[[cut_name]][["A22r6c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_independent$data[[cut_name]][["A22r6c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_independent$data[[cut_name]][["A22r6c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_independent$data[[cut_name]][["A22r6c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_independent$data[[cut_name]][["A22r6c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_independent$data[[cut_name]][["A22r6c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_independent$data[[cut_name]][["A22r6c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_independent"]] <- table_a22_attr_independent
print(paste("Generated frequency table: a22_attr_independent"))

# -----------------------------------------------------------------------------
# Table: a22_attr_premium (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Premium?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_premium <- list(
  tableId = "a22_attr_premium",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Premium?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_premium$data[[cut_name]] <- list()
  table_a22_attr_premium$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_premium$data[[cut_name]][["A22r1c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_premium$data[[cut_name]][["A22r1c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_premium$data[[cut_name]][["A22r1c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_premium$data[[cut_name]][["A22r1c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_premium$data[[cut_name]][["A22r1c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_premium$data[[cut_name]][["A22r1c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_premium$data[[cut_name]][["A22r1c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_premium"]] <- table_a22_attr_premium
print(paste("Generated frequency table: a22_attr_premium"))

# -----------------------------------------------------------------------------
# Table: a22_attr_reliable (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Reliable?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_reliable <- list(
  tableId = "a22_attr_reliable",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Reliable?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_reliable$data[[cut_name]] <- list()
  table_a22_attr_reliable$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_reliable$data[[cut_name]][["A22r8c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_reliable$data[[cut_name]][["A22r8c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_reliable$data[[cut_name]][["A22r8c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_reliable$data[[cut_name]][["A22r8c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_reliable$data[[cut_name]][["A22r8c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_reliable$data[[cut_name]][["A22r8c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_reliable$data[[cut_name]][["A22r8c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_reliable"]] <- table_a22_attr_reliable
print(paste("Generated frequency table: a22_attr_reliable"))

# -----------------------------------------------------------------------------
# Table: a22_attr_sophisticated_refined (frequency) [DERIVED]
# Question: Which of the following brands do you associate with the following attribute: Sophisticated / Refined?
# Rows: 7
# Source: a22
# -----------------------------------------------------------------------------

table_a22_attr_sophisticated_refined <- list(
  tableId = "a22_attr_sophisticated_refined",
  questionId = "A22",
  questionText = "Which of the following brands do you associate with the following attribute: Sophisticated / Refined?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a22",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts)) {
  ...
  additional_mask[is.na(additional_mask)] <- FALSE
  cut_data <- cut_data[additional_mask, ]
  table_a22_attr_sophisticated_refined$data[[cut_name]] <- list()
  table_a22_attr_sophisticated_refined$data[[cut_name]]$stat_letter <- cut_stat_letters[[cut_name]]
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_sophisticated_refined$data[[cut_name]][["A22r10c1_row_1"]] <- list(
      label = "Tito's Handmade Vodka",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_sophisticated_refined$data[[cut_name]][["A22r10c2_row_2"]] <- list(
      label = "Grey Goose",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_sophisticated_refined$data[[cut_name]][["A22r10c3_row_3"]] <- list(
      label = "Ketel One",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_sophisticated_refined$data[[cut_name]][["A22r10c4_row_4"]] <- list(
      label = "Maker's Mark",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_sophisticated_refined$data[[cut_name]][["A22r10c5_row_5"]] <- list(
      label = "Casamigos",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_sophisticated_refined$data[[cut_name]][["A22r10c6_row_6"]] <- list(
      label = "Don Julio",
      n = base_n,
      count = count,
      pct = pct,
  ...
  if (!is.null(var_col)) {
    ...
    table_a22_attr_sophisticated_refined$data[[cut_name]][["A22r10c7_row_7"]] <- list(
      label = "None of the above",
      n = base_n,
      count = count,
      pct = pct,
...
all_tables[["a22_attr_sophisticated_refined"]] <- table_a22_attr_sophisticated_refined
print(paste("Generated frequency table: a22_attr_sophisticated_refined"))
...
# Question: How likely are you to consider the following brand the next time you have a drink?
# Rows: 7
# Source: a23
# -----------------------------------------------------------------------------
...
table_a23_don_julio <- list(
  ...
  questionId = "A23",
  questionText = "How likely are you to consider the following brand the next time you have a drink?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a23",
  surveySection = "OCCASION LOOP",
  baseText = "Those who selected Don Julio at A21",
  userNote = "(Select one; this table is the Don Julio split)",
...
# Question: How likely are you to consider Grey Goose the next time you have a drink?
# Rows: 7
# Source: a23
# -----------------------------------------------------------------------------
...
table_a23_grey_goose <- list(
  ...
  questionId = "A23",
  questionText = "How likely are you to consider Grey Goose the next time you have a drink?",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a23",
  surveySection = "OCCASION LOOP",
  baseText = "Those who selected Grey Goose at A21",
  userNote = "(5-point likelihood scale; Top 2 Box = 4-5, Bottom 2 Box = 1-2)",
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a23_grey_goose$data[[cut_name]][["A23r2_row_5"]] <- list(
      label = "Unlikely (Bottom 2 Box / B2B)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
...
table_a23_ketel_one <- list(
  ...
  userNote = "(Select one per brand; only brands the respondent indicated awareness of were shown)",
...
table_a23_maker_s_mark <- list(
  ...
  userNote = "(5-point likelihood scale; Top 2 Box = 4-5)",
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_c3$data[[cut_name]][["C3r6_row_6"]] <- list(
      label = "Out of work for 1 year or more (not retired)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
  ...
  if (!is.null(var_col)) {
    ...
    table_c3$data[[cut_name]][["C3r7_row_7"]] <- list(
      label = "Out of work for less than 1 year (not retired)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
# Question: In addition to [INSERT A4], did you have any other drinks during at this location? (As a reminder, we’re asking about the drink you described for this location.)
# Rows: 2
# Source: a13a_1
# -----------------------------------------------------------------------------
...
table_a13a_1 <- list(
  tableId = "a13a_1",
  questionId = "A13a_1",
  questionText = "In addition to [INSERT A4], did you have any other drinks during at this location? (As a reminder, we’re asking about the drink you described for this location.)",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a13a_1",
  surveySection = "OCCASION LOOP",
  baseText = "Asked about the drink at a specific location in the occasion loop (Location 1 or Location 2)",
  userNote = "(Select one)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a13a_1$data[[cut_name]][["A13a_1_row_1"]] <- list(
      label = "Yes, I had one or more drinks in addition to [A4]",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
# -----------------------------------------------------------------------------
# Table: a13a_2 (frequency) [LOOP: Location 2]
# Question: In addition to [INSERT A4], did you have any other drinks during at this location?
# Rows: 2
# Source: a13a_2
# -----------------------------------------------------------------------------
...
table_a13a_2 <- list(
  tableId = "a13a_2",
  questionId = "A13a_2",
  questionText = "In addition to [INSERT A4], did you have any other drinks during at this location?",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a13a_2",
  surveySection = "OCCASION LOOP",
  baseText = "Respondents asked about the drink at the second location (Location 2).",
  userNote = "(Select one)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
# Question: What other drinks did you have in addition to your main drink?
# Rows: 6
# Source: a13b_1
# -----------------------------------------------------------------------------
...
table_a13b_1 <- list(
  tableId = "a13b_1",
  questionId = "A13b_1",
  questionText = "What other drinks did you have in addition to your main drink?",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a13b_1",
  surveySection = "OCCASION LOOP",
  baseText = "Respondents about the drink they had at a given location (Location 1 or Location 2 in the occasion loop)",
  userNote = "(Select all that apply)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
table_a14a_1 <- list(
  ...
  surveySection = "OCCASION LOOP",
  baseText = "Respondents whose drink was OFF-PREMISE (purchase-related questions shown)",
  userNote = "(Select one)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
for (cut_name in names(cuts)) {
  ...
  # Row 2: NET - Not purchased by respondent (NET) (components: A14a_1, A14a_1, A14a_1)
  net_vars <- c("A14a_1", "A14a_1", "A14a_1")
  net_respondents <- rep(FALSE, nrow(cut_data))
  for (net_var in net_vars) {
    var_col <- safe_get_var(cut_data, net_var)
    if (!is.null(var_col)) {
  ...
  pct <- if (base_n > 0) round_half_up(count / base_n * 100) else 0
    ...
    table_a14a_1$data[[cut_name]][["_NET_A14a_1_NotSelf_row_2"]] <- list(
      label = "Not purchased by respondent (NET)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
...
# Question: When you recently had a drink at the location, which of the following best describes your role in the original purchase of the drink for it? (Select one)
# Rows: 4
# Source: a14a_2
# -----------------------------------------------------------------------------
...
table_a14a_2 <- list(
  tableId = "a14a_2",
  questionId = "A14a_2",
  questionText = "When you recently had a drink at the location, which of the following best describes your role in the original purchase of the drink for it? (Select one)",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a14a_2",
  surveySection = "OCCASION LOOP",
  baseText = "Asked of respondents about the drink at the selected location (off-premise occasions only).",
  userNote = "(Select one)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
# Question: Given you purchased the drink for the recent occasion, where did you originally make the purchase?
# Rows: 15
# Source: a14b_1
# -----------------------------------------------------------------------------
...
table_a14b_1 <- list(
  tableId = "a14b_1",
  questionId = "A14b_1",
  questionText = "Given you purchased the drink for the recent occasion, where did you originally make the purchase?",
  tableType = "frequency",
  isDerived = TRUE,
  sourceTableId = "a14b_1",
  surveySection = "OCCASION LOOP",
  baseText = "Asked of respondents who purchased the drink for the recent occasion (A14a=1)",
  userNote = "(Flag respondents who select \"Other (specify)\" for follow-up review)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
for (cut_name in names(cuts)) {
  ...
  if (!is.null(var_col)) {
    ...
    table_a14b_1$data[[cut_name]][["A14b_1_row_14"]] <- list(
      label = "Other retail store (e.g., corner store, bodega, or other)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = FALSE,
...
table_a14b_2 <- list(
  ...
  baseText = "Respondents who purchased the drink themselves (asked when A14a=1)",
  userNote = "(Asked only if respondent purchased the drink themselves; options may be hidden by state)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
  data = list()
...
# Question: Which of the following best describes why you purchased the drink? (Select all that apply.)
# Rows: 10
# Source: a17_1
# -----------------------------------------------------------------------------
...
table_a17_1 <- list(
  tableId = "a17_1",
  questionId = "A17_1",
  questionText = "Which of the following best describes why you purchased the drink? (Select all that apply.)",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a17_1",
  surveySection = "OCCASION LOOP",
...
for (cut_name in names(cuts_stacked_loop_1)) {
  ...
  pct <- if (base_n > 0) round_half_up(count / base_n * 100) else 0
    ...
    table_a17_1$data[[cut_name]][["_NET_AnyA17_row_1"]] <- list(
...
table_a19_1 <- list(
  ...
  sourceTableId = "a19_1",
  surveySection = "OCCASION LOOP",
  baseText = "Asked of respondents who purchased the drink",
  userNote = "(Select all that apply)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
# Question: Did you consume any of the following products/substances at the same time as the drink you were describing? (Note: answers are confidential.)
# Rows: 7
# Source: a7_1
# -----------------------------------------------------------------------------
...
table_a7_1 <- list(
  tableId = "a7_1",
  questionId = "A7_1",
  questionText = "Did you consume any of the following products/substances at the same time as the drink you were describing? (Note: answers are confidential.)",
  tableType = "frequency",
  isDerived = FALSE,
  sourceTableId = "a7_1",
  surveySection = "OCCASION LOOP",
  baseText = "About the drink at the selected location (think about the first drink at that location)",
  userNote = "(Select all that apply)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
for (cut_name in names(cuts_stacked_loop_1)) {
  ...
  # Row 1: NET - Any of the substances (NET) (components: A7r1, A7r2, A7r3, A7r4, A7r5)
  ...
  pct <- if (base_n > 0) round_half_up(count / base_n * 100) else 0
    ...
    table_a7_1$data[[cut_name]][["_NET_A7_AnySubstance_row_1"]] <- list(
      label = "Any of the substances (NET)",
      n = base_n,
      count = count,
      pct = pct,
      isNet = TRUE,
...
table_a9_1 <- list(
  ...
  sourceTableId = "a9_1",
  surveySection = "OCCASION LOOP",
  baseText = "Respondents thinking about the specified recent drink (location loop)",
  userNote = "(Select all that apply)",
  tableSubtitle = "",
  excluded = FALSE,
  excludeReason = "",
...
for (cut_name in names(cuts_stacked_loop_1)) {
  ...
  pct <- if (base_n > 0) round_half_up(count / base_n * 100) else 0
    ...
    table_a9_1$data[[cut_name]][["_NET_AnyCompanion_row_1"]] <- list(
...
output <- list(
  metadata = list(
    generatedAt = "2026-02-07T07:05:05.358Z",
    tableCount = 60,
    cutCount = 20,
