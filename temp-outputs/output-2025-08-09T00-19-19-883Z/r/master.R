...
# Session: output-2025-08-09T00-19-19-883Z
# Generated: 2025-08-09T00:22:43.129Z

library(haven)
library(jsonlite)
data <- read_sav('temp-outputs/output-2025-08-09T00-19-19-883Z/dataFile.sav')
...
dir.create('temp-outputs/output-2025-08-09T00-19-19-883Z/results', recursive = TRUE, showWarnings = FALSE)
write_table <- function(data, var_name, levels_df, table_id) {
  ...
  write.csv(out, sprintf('temp-outputs/output-2025-08-09T00-19-19-883Z/results/%s.csv', table_id), row.names = FALSE)
}
...
write_json(preflight, 'temp-outputs/output-2025-08-09T00-19-19-883Z/r/preflight.json', auto_unbox = TRUE, pretty = TRUE)
