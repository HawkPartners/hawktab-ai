...
# Session: output-2025-08-11T14-46-59-237Z
# Generated: 2025-08-11T14:54:06.841Z

library(haven)
library(jsonlite)
data <- read_sav('temp-outputs/output-2025-08-11T14-46-59-237Z/dataFile.sav')
...
dir.create('temp-outputs/output-2025-08-11T14-46-59-237Z/results', recursive = TRUE, showWarnings = FALSE)
write_table <- function(data, var_name, levels_df, table_id) {
  ...
  write.csv(out, sprintf('temp-outputs/output-2025-08-11T14-46-59-237Z/results/%s.csv', table_id), row.names = FALSE)
}
...
if (ok) write_table(data, 'S6', NULL, 's6')
...
if (ok) write_table(data, 'S10', NULL, 's10')
...
if (ok) write_table(data, 'S11', NULL, 's11')
...
if (ok) write_table(data, 'US_State', NULL, 'us-state')
...
if (ok) write_table(data, 'B4', NULL, 'b4')
...
write_json(preflight, 'temp-outputs/output-2025-08-11T14-46-59-237Z/r/preflight.json', auto_unbox = TRUE, pretty = TRUE)
