...
# Session: output-2025-08-11T11-50-01-709Z
# Generated: 2025-08-11T11:56:13.154Z

library(haven)
library(jsonlite)
data <- read_sav('temp-outputs/output-2025-08-11T11-50-01-709Z/dataFile.sav')
...
dir.create('temp-outputs/output-2025-08-11T11-50-01-709Z/results', recursive = TRUE, showWarnings = FALSE)
write_table <- function(data, var_name, levels_df, table_id) {
  ...
  write.csv(out, sprintf('temp-outputs/output-2025-08-11T11-50-01-709Z/results/%s.csv', table_id), row.names = FALSE)
}
...
write_json(preflight, 'temp-outputs/output-2025-08-11T11-50-01-709Z/r/preflight.json', auto_unbox = TRUE, pretty = TRUE)
